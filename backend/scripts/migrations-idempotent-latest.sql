...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE INDEX IF NOT EXISTS "IX_BackgroundJobs_JobType_State" ON "BackgroundJobs" ("JobType", "State");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE INDEX IF NOT EXISTS "IX_BackgroundJobs_ScheduledAt" ON "BackgroundJobs" ("ScheduledAt") WHERE "ScheduledAt" IS NOT NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE INDEX IF NOT EXISTS "IX_BackgroundJobs_State_Priority_CreatedAt" ON "BackgroundJobs" ("State", "Priority", "CreatedAt");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_CostCentres_CompanyId_Code" ON "CostCentres" ("CompanyId", "Code");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE INDEX IF NOT EXISTS "IX_DocumentPlaceholderDefinitions_DocumentType" ON "DocumentPlaceholderDefinitions" ("DocumentType");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_DocumentPlaceholderDefinitions_DocumentType_Key" ON "DocumentPlaceholderDefinitions" ("DocumentType", "Key");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE INDEX IF NOT EXISTS "IX_DocumentTemplates_CompanyId_DocumentType_PartnerId_IsActive" ON "DocumentTemplates" ("CompanyId", "DocumentType", "PartnerId", "IsActive");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE INDEX IF NOT EXISTS "IX_DocumentTemplates_CompanyId_IsActive" ON "DocumentTemplates" ("CompanyId", "IsActive");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_EmailMessages_CompanyId_MessageId" ON "EmailMessages" ("CompanyId", "MessageId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE INDEX IF NOT EXISTS "IX_GeneratedDocuments_CompanyId_DocumentType_GeneratedAt" ON "GeneratedDocuments" ("CompanyId", "DocumentType", "GeneratedAt");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE INDEX IF NOT EXISTS "IX_GeneratedDocuments_CompanyId_ReferenceEntity_ReferenceId" ON "GeneratedDocuments" ("CompanyId", "ReferenceEntity", "ReferenceId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE INDEX IF NOT EXISTS "IX_GeneratedDocuments_FileId" ON "GeneratedDocuments" ("FileId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE INDEX IF NOT EXISTS "IX_GeneratedDocuments_TemplateId" ON "GeneratedDocuments" ("TemplateId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE INDEX IF NOT EXISTS "IX_KpiProfiles_CompanyId_IsDefault_OrderType" ON "KpiProfiles" ("CompanyId", "IsDefault", "OrderType");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE INDEX IF NOT EXISTS "IX_KpiProfiles_CompanyId_PartnerId_OrderType_BuildingTypeId_Ef~" ON "KpiProfiles" ("CompanyId", "PartnerId", "OrderType", "BuildingTypeId", "EffectiveFrom");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE INDEX IF NOT EXISTS "IX_MaterialAllocations_DepartmentId" ON "MaterialAllocations" ("DepartmentId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE INDEX IF NOT EXISTS "IX_MaterialTemplateItems_MaterialId" ON "MaterialTemplateItems" ("MaterialId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE INDEX IF NOT EXISTS "IX_MaterialTemplateItems_MaterialTemplateId" ON "MaterialTemplateItems" ("MaterialTemplateId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE INDEX IF NOT EXISTS "IX_MaterialTemplates_CompanyId_IsActive" ON "MaterialTemplates" ("CompanyId", "IsActive");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE INDEX IF NOT EXISTS "IX_MaterialTemplates_CompanyId_IsDefault_OrderType" ON "MaterialTemplates" ("CompanyId", "IsDefault", "OrderType");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE INDEX IF NOT EXISTS "IX_MaterialTemplates_CompanyId_OrderType_BuildingTypeId_Partne~" ON "MaterialTemplates" ("CompanyId", "OrderType", "BuildingTypeId", "PartnerId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_Orders_CompanyId_ServiceId" ON "Orders" ("CompanyId", "ServiceId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE INDEX IF NOT EXISTS "IX_PayrollLines_PayrollRunId" ON "PayrollLines" ("PayrollRunId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_PayrollPeriods_CompanyId_Period" ON "PayrollPeriods" ("CompanyId", "Period");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE INDEX IF NOT EXISTS "IX_PayrollRuns_PayrollPeriodId" ON "PayrollRuns" ("PayrollPeriodId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE INDEX IF NOT EXISTS "IX_PnlFacts_PnlPeriodId" ON "PnlFacts" ("PnlPeriodId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_PnlPeriods_CompanyId_Period" ON "PnlPeriods" ("CompanyId", "Period");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE INDEX IF NOT EXISTS "IX_RmaRequestItems_RmaRequestId" ON "RmaRequestItems" ("RmaRequestId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE INDEX IF NOT EXISTS "IX_SerialisedItems_CurrentLocationId" ON "SerialisedItems" ("CurrentLocationId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE INDEX IF NOT EXISTS "IX_SerialisedItems_MaterialId" ON "SerialisedItems" ("MaterialId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_SiAvailabilities_CompanyId_ServiceInstallerId_Date" ON "SiAvailabilities" ("CompanyId", "ServiceInstallerId", "Date");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_SplitterPorts_CompanyId_SplitterId_PortNumber" ON "SplitterPorts" ("CompanyId", "SplitterId", "PortNumber");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE INDEX IF NOT EXISTS "IX_StockBalances_MaterialId" ON "StockBalances" ("MaterialId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE INDEX IF NOT EXISTS "IX_StockBalances_StockLocationId" ON "StockBalances" ("StockLocationId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE INDEX IF NOT EXISTS "IX_StockMovements_MaterialId" ON "StockMovements" ("MaterialId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE INDEX IF NOT EXISTS "IX_SystemLogs_CompanyId_Category_CreatedAt" ON "SystemLogs" ("CompanyId", "Category", "CreatedAt");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE INDEX IF NOT EXISTS "IX_SystemLogs_EntityType_EntityId_CreatedAt" ON "SystemLogs" ("EntityType", "EntityId", "CreatedAt");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE INDEX IF NOT EXISTS "IX_SystemLogs_Severity_CreatedAt" ON "SystemLogs" ("Severity", "CreatedAt");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_UserRoles_UserId_CompanyId_RoleId" ON "UserRoles" ("UserId", "CompanyId", "RoleId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE INDEX IF NOT EXISTS "IX_WorkflowDefinitions_CompanyId_EntityType_IsActive" ON "WorkflowDefinitions" ("CompanyId", "EntityType", "IsActive");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE INDEX IF NOT EXISTS "IX_WorkflowDefinitions_CompanyId_Name" ON "WorkflowDefinitions" ("CompanyId", "Name");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE INDEX IF NOT EXISTS "IX_WorkflowJobs_CompanyId_EntityType_EntityId" ON "WorkflowJobs" ("CompanyId", "EntityType", "EntityId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE INDEX IF NOT EXISTS "IX_WorkflowJobs_CompanyId_State_CreatedAt" ON "WorkflowJobs" ("CompanyId", "State", "CreatedAt");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE INDEX IF NOT EXISTS "IX_WorkflowJobs_WorkflowDefinitionId_EntityId" ON "WorkflowJobs" ("WorkflowDefinitionId", "EntityId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_WorkflowTransitions_CompanyId_WorkflowDefinitionId_FromStat~" ON "WorkflowTransitions" ("CompanyId", "WorkflowDefinitionId", "FromStatus", "ToStatus");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE INDEX IF NOT EXISTS "IX_WorkflowTransitions_CompanyId_WorkflowDefinitionId_IsActive" ON "WorkflowTransitions" ("CompanyId", "WorkflowDefinitionId", "IsActive");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123142132_InitialCreate') THEN
    CREATE INDEX IF NOT EXISTS "IX_WorkflowTransitions_WorkflowDefinitionId" ON "WorkflowTransitions" ("WorkflowDefinitionId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123185309_AddCompanyDocuments') THEN
    CREATE INDEX IF NOT EXISTS "IX_BillingRatecards_CompanyId_EffectiveFrom_EffectiveTo" ON "BillingRatecards" ("CompanyId", "EffectiveFrom", "EffectiveTo");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123185309_AddCompanyDocuments') THEN
    CREATE INDEX IF NOT EXISTS "IX_BillingRatecards_CompanyId_IsActive" ON "BillingRatecards" ("CompanyId", "IsActive");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123185309_AddCompanyDocuments') THEN
    CREATE INDEX IF NOT EXISTS "IX_BillingRatecards_CompanyId_PartnerId_OrderTypeId" ON "BillingRatecards" ("CompanyId", "PartnerId", "OrderTypeId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123185309_AddCompanyDocuments') THEN
    CREATE INDEX IF NOT EXISTS "IX_CompanyDocuments_CompanyId_Category" ON "CompanyDocuments" ("CompanyId", "Category");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123185309_AddCompanyDocuments') THEN
    CREATE INDEX IF NOT EXISTS "IX_CompanyDocuments_CompanyId_ExpiryDate" ON "CompanyDocuments" ("CompanyId", "ExpiryDate");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123185309_AddCompanyDocuments') THEN
    CREATE INDEX IF NOT EXISTS "IX_CompanyDocuments_CompanyId_IsCritical" ON "CompanyDocuments" ("CompanyId", "IsCritical");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123185309_AddCompanyDocuments') THEN
    CREATE INDEX IF NOT EXISTS "IX_CompanyDocuments_FileId" ON "CompanyDocuments" ("FileId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123193706_AddDepartmentIdToPartnersBuildingsSplitters') THEN
    CREATE INDEX IF NOT EXISTS "IX_Splitters_CompanyId_DepartmentId" ON "Splitters" ("CompanyId", "DepartmentId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123193706_AddDepartmentIdToPartnersBuildingsSplitters') THEN
    CREATE INDEX IF NOT EXISTS "IX_Splitters_DepartmentId" ON "Splitters" ("DepartmentId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123193706_AddDepartmentIdToPartnersBuildingsSplitters') THEN
    CREATE INDEX IF NOT EXISTS "IX_Partners_CompanyId_DepartmentId" ON "Partners" ("CompanyId", "DepartmentId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123193706_AddDepartmentIdToPartnersBuildingsSplitters') THEN
    CREATE INDEX IF NOT EXISTS "IX_Partners_DepartmentId" ON "Partners" ("DepartmentId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123193706_AddDepartmentIdToPartnersBuildingsSplitters') THEN
    CREATE INDEX IF NOT EXISTS "IX_Buildings_CompanyId_DepartmentId" ON "Buildings" ("CompanyId", "DepartmentId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251123193706_AddDepartmentIdToPartnersBuildingsSplitters') THEN
    CREATE INDEX IF NOT EXISTS "IX_Buildings_DepartmentId" ON "Buildings" ("DepartmentId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251124035749_AddOrderTypeInstallationTypeBuildingTypeSplitterType') THEN
    CREATE TABLE IF NOT EXISTS "SplitterTypes" (
        "Id" uuid NOT NULL,
        "DepartmentId" uuid,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251124035749_AddOrderTypeInstallationTypeBuildingTypeSplitterType') THEN
    CREATE INDEX IF NOT EXISTS "IX_Splitters_SplitterTypeId" ON "Splitters" ("SplitterTypeId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251124035749_AddOrderTypeInstallationTypeBuildingTypeSplitterType') THEN
    CREATE INDEX IF NOT EXISTS "IX_Orders_InstallationTypeId" ON "Orders" ("InstallationTypeId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251124035749_AddOrderTypeInstallationTypeBuildingTypeSplitterType') THEN
    CREATE INDEX IF NOT EXISTS "IX_Orders_OrderTypeId" ON "Orders" ("OrderTypeId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251124035749_AddOrderTypeInstallationTypeBuildingTypeSplitterType') THEN
    CREATE INDEX IF NOT EXISTS "IX_Buildings_BuildingTypeId" ON "Buildings" ("BuildingTypeId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251124035749_AddOrderTypeInstallationTypeBuildingTypeSplitterType') THEN
    CREATE INDEX IF NOT EXISTS "IX_BuildingTypes_CompanyId_Code" ON "BuildingTypes" ("CompanyId", "Code");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251124035749_AddOrderTypeInstallationTypeBuildingTypeSplitterType') THEN
    CREATE INDEX IF NOT EXISTS "IX_BuildingTypes_CompanyId_DepartmentId" ON "BuildingTypes" ("CompanyId", "DepartmentId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251124035749_AddOrderTypeInstallationTypeBuildingTypeSplitterType') THEN
    CREATE INDEX IF NOT EXISTS "IX_BuildingTypes_CompanyId_IsActive" ON "BuildingTypes" ("CompanyId", "IsActive");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251124035749_AddOrderTypeInstallationTypeBuildingTypeSplitterType') THEN
    CREATE INDEX IF NOT EXISTS "IX_BuildingTypes_DepartmentId" ON "BuildingTypes" ("DepartmentId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251124035749_AddOrderTypeInstallationTypeBuildingTypeSplitterType') THEN
    CREATE INDEX IF NOT EXISTS "IX_InstallationTypes_CompanyId_Code" ON "InstallationTypes" ("CompanyId", "Code");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251124035749_AddOrderTypeInstallationTypeBuildingTypeSplitterType') THEN
    CREATE INDEX IF NOT EXISTS "IX_InstallationTypes_CompanyId_DepartmentId" ON "InstallationTypes" ("CompanyId", "DepartmentId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251124035749_AddOrderTypeInstallationTypeBuildingTypeSplitterType') THEN
    CREATE INDEX IF NOT EXISTS "IX_InstallationTypes_CompanyId_IsActive" ON "InstallationTypes" ("CompanyId", "IsActive");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251124035749_AddOrderTypeInstallationTypeBuildingTypeSplitterType') THEN
    CREATE INDEX IF NOT EXISTS "IX_InstallationTypes_DepartmentId" ON "InstallationTypes" ("DepartmentId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251124035749_AddOrderTypeInstallationTypeBuildingTypeSplitterType') THEN
    CREATE INDEX IF NOT EXISTS "IX_OrderTypes_CompanyId_Code" ON "OrderTypes" ("CompanyId", "Code");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251124035749_AddOrderTypeInstallationTypeBuildingTypeSplitterType') THEN
    CREATE INDEX IF NOT EXISTS "IX_OrderTypes_CompanyId_DepartmentId" ON "OrderTypes" ("CompanyId", "DepartmentId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251124035749_AddOrderTypeInstallationTypeBuildingTypeSplitterType') THEN
    CREATE INDEX IF NOT EXISTS "IX_OrderTypes_CompanyId_IsActive" ON "OrderTypes" ("CompanyId", "IsActive");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251124035749_AddOrderTypeInstallationTypeBuildingTypeSplitterType') THEN
    CREATE INDEX IF NOT EXISTS "IX_OrderTypes_DepartmentId" ON "OrderTypes" ("DepartmentId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251124035749_AddOrderTypeInstallationTypeBuildingTypeSplitterType') THEN
    CREATE INDEX IF NOT EXISTS "IX_SplitterTypes_CompanyId_Code" ON "SplitterTypes" ("CompanyId", "Code");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251124035749_AddOrderTypeInstallationTypeBuildingTypeSplitterType') THEN
    CREATE INDEX IF NOT EXISTS "IX_SplitterTypes_CompanyId_DepartmentId" ON "SplitterTypes" ("CompanyId", "DepartmentId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251124035749_AddOrderTypeInstallationTypeBuildingTypeSplitterType') THEN
    CREATE INDEX IF NOT EXISTS "IX_SplitterTypes_CompanyId_IsActive" ON "SplitterTypes" ("CompanyId", "IsActive");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251124035749_AddOrderTypeInstallationTypeBuildingTypeSplitterType') THEN
    CREATE INDEX IF NOT EXISTS "IX_SplitterTypes_DepartmentId" ON "SplitterTypes" ("DepartmentId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251124051255_AddVerticalsTable') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_Verticals_CompanyId_Code" ON "Verticals" ("CompanyId", "Code");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251124051255_AddVerticalsTable') THEN
    CREATE INDEX IF NOT EXISTS "IX_Verticals_CompanyId_IsActive" ON "Verticals" ("CompanyId", "IsActive");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251125100326_AddDepartmentIdToMaterial_Update') THEN
    CREATE INDEX IF NOT EXISTS "IX_Materials_DepartmentId" ON "Materials" ("DepartmentId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251125101723_AddMaterialCategory') THEN
    CREATE INDEX IF NOT EXISTS "IX_MaterialCategories_CompanyId_IsActive" ON "MaterialCategories" ("CompanyId", "IsActive");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251125101723_AddMaterialCategory') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_MaterialCategories_CompanyId_Name" ON "MaterialCategories" ("CompanyId", "Name");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251125101723_AddMaterialCategory') THEN
    CREATE INDEX IF NOT EXISTS "IX_MaterialCategories_DisplayOrder" ON "MaterialCategories" ("DisplayOrder");
    END IF;
END $EF$;
...
BEGIN
    ...
    CREATE INDEX IF NOT EXISTS "IX_Materials_PartnerId" ON "Materials" ("PartnerId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251125170149_AddEmailAccounts') THEN
    CREATE INDEX IF NOT EXISTS "IX_EmailAccounts_CompanyId_Name" ON "EmailAccounts" ("CompanyId", "Name");
    END IF;
END $EF$;
...
BEGIN
    ...
    CREATE TABLE IF NOT EXISTS "ServiceInstallerContacts" (
        "Id" uuid NOT NULL,
        "ServiceInstallerId" uuid NOT NULL,
        "Name" text NOT NULL,
        "Phone" text,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251126150839_SyncModelChanges') THEN
    CREATE INDEX IF NOT EXISTS "IX_ServiceInstallerContacts_ServiceInstallerId" ON "ServiceInstallerContacts" ("ServiceInstallerId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251126174910_AddPnlTypesAssetsAndAccounting') THEN
    CREATE INDEX IF NOT EXISTS "IX_AssetDepreciationEntries_AssetId" ON "AssetDepreciationEntries" ("AssetId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251126174910_AddPnlTypesAssetsAndAccounting') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_AssetDepreciationEntries_CompanyId_AssetId_Period" ON "AssetDepreciationEntries" ("CompanyId", "AssetId", "Period");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251126174910_AddPnlTypesAssetsAndAccounting') THEN
    CREATE INDEX IF NOT EXISTS "IX_AssetDepreciationEntries_CompanyId_Period" ON "AssetDepreciationEntries" ("CompanyId", "Period");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251126174910_AddPnlTypesAssetsAndAccounting') THEN
    CREATE INDEX IF NOT EXISTS "IX_AssetDepreciationEntries_IsPosted" ON "AssetDepreciationEntries" ("IsPosted");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251126174910_AddPnlTypesAssetsAndAccounting') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_AssetDisposals_AssetId" ON "AssetDisposals" ("AssetId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251126174910_AddPnlTypesAssetsAndAccounting') THEN
    CREATE INDEX IF NOT EXISTS "IX_AssetMaintenanceRecords_AssetId" ON "AssetMaintenanceRecords" ("AssetId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251126174910_AddPnlTypesAssetsAndAccounting') THEN
    CREATE INDEX IF NOT EXISTS "IX_AssetMaintenanceRecords_CompanyId_AssetId" ON "AssetMaintenanceRecords" ("CompanyId", "AssetId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251126174910_AddPnlTypesAssetsAndAccounting') THEN
    CREATE INDEX IF NOT EXISTS "IX_AssetMaintenanceRecords_IsCompleted" ON "AssetMaintenanceRecords" ("IsCompleted");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251126174910_AddPnlTypesAssetsAndAccounting') THEN
    CREATE INDEX IF NOT EXISTS "IX_AssetMaintenanceRecords_NextScheduledDate" ON "AssetMaintenanceRecords" ("NextScheduledDate");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251126174910_AddPnlTypesAssetsAndAccounting') THEN
    CREATE INDEX IF NOT EXISTS "IX_AssetMaintenanceRecords_PerformedDate" ON "AssetMaintenanceRecords" ("PerformedDate");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251126174910_AddPnlTypesAssetsAndAccounting') THEN
    CREATE INDEX IF NOT EXISTS "IX_AssetMaintenanceRecords_ScheduledDate" ON "AssetMaintenanceRecords" ("ScheduledDate");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251126174910_AddPnlTypesAssetsAndAccounting') THEN
    CREATE INDEX IF NOT EXISTS "IX_Assets_AssetTypeId" ON "Assets" ("AssetTypeId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251126174910_AddPnlTypesAssetsAndAccounting') THEN
    CREATE INDEX IF NOT EXISTS "IX_PnlTypes_ParentId" ON "PnlTypes" ("ParentId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251126174910_AddPnlTypesAssetsAndAccounting') THEN
    CREATE INDEX IF NOT EXISTS "IX_SupplierInvoiceLineItems_SupplierInvoiceId_LineNumber" ON "SupplierInvoiceLineItems" ("SupplierInvoiceId", "LineNumber");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251129163409_AddDepartmentMemberships') THEN
    CREATE INDEX IF NOT EXISTS "IX_DepartmentMemberships_DepartmentId" ON "DepartmentMemberships" ("DepartmentId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251129163409_AddDepartmentMemberships') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_DepartmentMemberships_UserId_DepartmentId" ON "DepartmentMemberships" ("UserId", "DepartmentId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251129164118_AddOrderDepartment') THEN
    CREATE INDEX IF NOT EXISTS "IX_Orders_DepartmentId" ON "Orders" ("DepartmentId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251129191720_AddTimeSlots') THEN
    CREATE INDEX IF NOT EXISTS "IX_TimeSlots_CompanyId" ON "TimeSlots" ("CompanyId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251129191720_AddTimeSlots') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_TimeSlots_CompanyId_Time" ON "TimeSlots" ("CompanyId", "Time");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251129191720_AddTimeSlots') THEN
    CREATE INDEX IF NOT EXISTS "IX_TimeSlots_SortOrder" ON "TimeSlots" ("SortOrder");
    END IF;
END $EF$;
    ...
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251201043956_AddDefaultParserTemplateToEmailAccounts') THEN
                    ...
                    BEGIN
                        IF NOT EXISTS (
                            ...
                            ALTER TABLE "VipEmails" ADD COLUMN IF NOT EXISTS "DepartmentId" uuid NULL;
                        END IF;
                    END $$;
    ...
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251201043956_AddDefaultParserTemplateToEmailAccounts') THEN
                    ...
                    BEGIN
                        IF NOT EXISTS (
                            ...
                            ALTER TABLE "EmailMessages" ADD COLUMN IF NOT EXISTS "DepartmentId" uuid NULL;
                        END IF;
                    END $$;
    ...
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251201043956_AddDefaultParserTemplateToEmailAccounts') THEN
                    ...
                    BEGIN
                        IF NOT EXISTS (
                            ...
                            ALTER TABLE "EmailMessages" ADD COLUMN IF NOT EXISTS "Direction" character varying(20) NOT NULL DEFAULT 'Inbound';
                        END IF;
                    END $$;
    ...
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251201043956_AddDefaultParserTemplateToEmailAccounts') THEN
                    ...
                    BEGIN
                        IF NOT EXISTS (
                            ...
                            ALTER TABLE "EmailMessages" ADD COLUMN IF NOT EXISTS "SentAt" timestamp with time zone NULL;
                        END IF;
                    END $$;
                    ...
                    BEGIN
                        IF EXISTS (
                            ...
                            IF NOT EXISTS (
                                ...
                                CREATE UNIQUE INDEX IF NOT EXISTS "IX_EmailTemplates_CompanyId_Code" 
                            ...
                            IF NOT EXISTS (
                                ...
                                CREATE INDEX IF NOT EXISTS "IX_EmailTemplates_CompanyId_DepartmentId_IsActive" 
                            ...
                            IF NOT EXISTS (
                                ...
                                CREATE INDEX IF NOT EXISTS "IX_EmailTemplates_CompanyId_Priority_IsActive" 
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202155247_AddRateEngineAndInstallationMethod') THEN
    CREATE TABLE IF NOT EXISTS "CustomRates" (
        "Id" uuid NOT NULL,
        "UserId" uuid NOT NULL,
        "DepartmentId" uuid,
        "VerticalId" uuid,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202155247_AddRateEngineAndInstallationMethod') THEN
    CREATE TABLE IF NOT EXISTS "GponPartnerJobRates" (
        "Id" uuid NOT NULL,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202155247_AddRateEngineAndInstallationMethod') THEN
    CREATE TABLE IF NOT EXISTS "GponSiCustomRates" (
        "Id" uuid NOT NULL,
        "ServiceInstallerId" uuid NOT NULL,
        "OrderTypeId" uuid NOT NULL,
        "InstallationTypeId" uuid NOT NULL,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202155247_AddRateEngineAndInstallationMethod') THEN
    CREATE TABLE IF NOT EXISTS "GponSiJobRates" (
        "Id" uuid NOT NULL,
        "OrderTypeId" uuid NOT NULL,
        "InstallationTypeId" uuid NOT NULL,
        "InstallationMethodId" uuid,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202155247_AddRateEngineAndInstallationMethod') THEN
    CREATE TABLE IF NOT EXISTS "RateCardLines" (
        "Id" uuid NOT NULL,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202155247_AddRateEngineAndInstallationMethod') THEN
    CREATE INDEX IF NOT EXISTS "IX_Orders_InstallationMethodId" ON "Orders" ("InstallationMethodId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202155247_AddRateEngineAndInstallationMethod') THEN
    CREATE INDEX IF NOT EXISTS "IX_Orders_OrderTypeId_InstallationTypeId_InstallationMethodId" ON "Orders" ("OrderTypeId", "InstallationTypeId", "InstallationMethodId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202155247_AddRateEngineAndInstallationMethod') THEN
    CREATE INDEX IF NOT EXISTS "IX_CustomRates_UserId_DepartmentId_IsActive" ON "CustomRates" ("UserId", "DepartmentId", "IsActive");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202155247_AddRateEngineAndInstallationMethod') THEN
    CREATE INDEX IF NOT EXISTS "IX_CustomRates_UserId_Dimension1_Dimension2_Dimension3_Dimensi~" ON "CustomRates" ("UserId", "Dimension1", "Dimension2", "Dimension3", "Dimension4");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202155247_AddRateEngineAndInstallationMethod') THEN
    CREATE INDEX IF NOT EXISTS "IX_CustomRates_ValidFrom_ValidTo" ON "CustomRates" ("ValidFrom", "ValidTo");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202155247_AddRateEngineAndInstallationMethod') THEN
    CREATE INDEX IF NOT EXISTS "IX_GponPartnerJobRates_CompanyId_IsActive" ON "GponPartnerJobRates" ("CompanyId", "IsActive");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202155247_AddRateEngineAndInstallationMethod') THEN
    CREATE INDEX IF NOT EXISTS "IX_GponPartnerJobRates_PartnerGroupId_OrderTypeId_Installation~" ON "GponPartnerJobRates" ("PartnerGroupId", "OrderTypeId", "InstallationTypeId", "InstallationMethodId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202155247_AddRateEngineAndInstallationMethod') THEN
    CREATE INDEX IF NOT EXISTS "IX_GponPartnerJobRates_PartnerId_OrderTypeId_InstallationTypeI~" ON "GponPartnerJobRates" ("PartnerId", "OrderTypeId", "InstallationTypeId", "InstallationMethodId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202155247_AddRateEngineAndInstallationMethod') THEN
    CREATE INDEX IF NOT EXISTS "IX_GponPartnerJobRates_ValidFrom_ValidTo" ON "GponPartnerJobRates" ("ValidFrom", "ValidTo");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202155247_AddRateEngineAndInstallationMethod') THEN
    CREATE INDEX IF NOT EXISTS "IX_GponSiCustomRates_ApprovedByUserId" ON "GponSiCustomRates" ("ApprovedByUserId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202155247_AddRateEngineAndInstallationMethod') THEN
    CREATE INDEX IF NOT EXISTS "IX_GponSiCustomRates_CompanyId_IsActive" ON "GponSiCustomRates" ("CompanyId", "IsActive");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202155247_AddRateEngineAndInstallationMethod') THEN
    CREATE INDEX IF NOT EXISTS "IX_GponSiCustomRates_ServiceInstallerId_OrderTypeId_Installati~" ON "GponSiCustomRates" ("ServiceInstallerId", "OrderTypeId", "InstallationTypeId", "InstallationMethodId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202155247_AddRateEngineAndInstallationMethod') THEN
    CREATE INDEX IF NOT EXISTS "IX_GponSiCustomRates_ServiceInstallerId_PartnerGroupId" ON "GponSiCustomRates" ("ServiceInstallerId", "PartnerGroupId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202155247_AddRateEngineAndInstallationMethod') THEN
    CREATE INDEX IF NOT EXISTS "IX_GponSiCustomRates_ValidFrom_ValidTo" ON "GponSiCustomRates" ("ValidFrom", "ValidTo");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202155247_AddRateEngineAndInstallationMethod') THEN
    CREATE INDEX IF NOT EXISTS "IX_GponSiJobRates_CompanyId_IsActive" ON "GponSiJobRates" ("CompanyId", "IsActive");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202155247_AddRateEngineAndInstallationMethod') THEN
    CREATE INDEX IF NOT EXISTS "IX_GponSiJobRates_OrderTypeId_InstallationTypeId_InstallationM~" ON "GponSiJobRates" ("OrderTypeId", "InstallationTypeId", "InstallationMethodId", "SiLevel");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202155247_AddRateEngineAndInstallationMethod') THEN
    CREATE INDEX IF NOT EXISTS "IX_GponSiJobRates_PartnerGroupId_OrderTypeId_InstallationTypeId" ON "GponSiJobRates" ("PartnerGroupId", "OrderTypeId", "InstallationTypeId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202155247_AddRateEngineAndInstallationMethod') THEN
    CREATE INDEX IF NOT EXISTS "IX_GponSiJobRates_ValidFrom_ValidTo" ON "GponSiJobRates" ("ValidFrom", "ValidTo");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202155247_AddRateEngineAndInstallationMethod') THEN
    CREATE INDEX IF NOT EXISTS "IX_RateCardLines_RateCardId_Dimension1_Dimension2_Dimension3_D~" ON "RateCardLines" ("RateCardId", "Dimension1", "Dimension2", "Dimension3", "Dimension4");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202155247_AddRateEngineAndInstallationMethod') THEN
    CREATE INDEX IF NOT EXISTS "IX_RateCardLines_RateCardId_IsActive" ON "RateCardLines" ("RateCardId", "IsActive");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202155247_AddRateEngineAndInstallationMethod') THEN
    CREATE INDEX IF NOT EXISTS "IX_RateCardLines_RateCardId_PartnerGroupId_PartnerId" ON "RateCardLines" ("RateCardId", "PartnerGroupId", "PartnerId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202155247_AddRateEngineAndInstallationMethod') THEN
    CREATE INDEX IF NOT EXISTS "IX_RateCards_CompanyId_RateContext_RateKind_IsActive" ON "RateCards" ("CompanyId", "RateContext", "RateKind", "IsActive");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202155247_AddRateEngineAndInstallationMethod') THEN
    CREATE INDEX IF NOT EXISTS "IX_RateCards_CompanyId_VerticalId_DepartmentId" ON "RateCards" ("CompanyId", "VerticalId", "DepartmentId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202155247_AddRateEngineAndInstallationMethod') THEN
    CREATE INDEX IF NOT EXISTS "IX_RateCards_ValidFrom_ValidTo" ON "RateCards" ("ValidFrom", "ValidTo");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202155910_AddPartnerGroupIdToBillingRatecard') THEN
    CREATE INDEX IF NOT EXISTS "IX_BillingRatecards_CompanyId_PartnerGroupId_OrderTypeId_Insta~" ON "BillingRatecards" ("CompanyId", "PartnerGroupId", "OrderTypeId", "InstallationMethodId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202155910_AddPartnerGroupIdToBillingRatecard') THEN
    CREATE INDEX IF NOT EXISTS "IX_BillingRatecards_CompanyId_PartnerGroupId_PartnerId_OrderTy~" ON "BillingRatecards" ("CompanyId", "PartnerGroupId", "PartnerId", "OrderTypeId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202162647_EnhancePnlDetailPerOrder') THEN
    CREATE INDEX IF NOT EXISTS "IX_PnlDetailPerOrders_CompanyId_Period_OrderType" ON "PnlDetailPerOrders" ("CompanyId", "Period", "OrderType");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202162647_EnhancePnlDetailPerOrder') THEN
    CREATE INDEX IF NOT EXISTS "IX_PnlDetailPerOrders_DepartmentId" ON "PnlDetailPerOrders" ("DepartmentId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202162647_EnhancePnlDetailPerOrder') THEN
    CREATE INDEX IF NOT EXISTS "IX_PnlDetailPerOrders_ServiceInstallerId" ON "PnlDetailPerOrders" ("ServiceInstallerId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202173338_AddSameDayRescheduleEvidence') THEN
    CREATE INDEX IF NOT EXISTS "IX_OrderReschedules_IsSameDayReschedule" ON "OrderReschedules" ("IsSameDayReschedule");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202173502_AddBlockerEvidenceFields') THEN
    CREATE INDEX IF NOT EXISTS "IX_OrderBlockers_BlockerCategory" ON "OrderBlockers" ("BlockerCategory");
    END IF;
END $EF$;
...
BEGIN
    ...
    CREATE TABLE IF NOT EXISTS "AuditOverrides" (
        "Id" uuid NOT NULL,
        "EntityType" character varying(100) NOT NULL,
        "EntityId" uuid NOT NULL,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202174507_AddAuditOverrideEntity') THEN
    CREATE INDEX IF NOT EXISTS "IX_AuditOverrides_CompanyId_EntityType_EntityId" ON "AuditOverrides" ("CompanyId", "EntityType", "EntityId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202174507_AddAuditOverrideEntity') THEN
    CREATE INDEX IF NOT EXISTS "IX_AuditOverrides_CompanyId_OverriddenByUserId_OverriddenAt" ON "AuditOverrides" ("CompanyId", "OverriddenByUserId", "OverriddenAt");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202174507_AddAuditOverrideEntity') THEN
    CREATE INDEX IF NOT EXISTS "IX_AuditOverrides_OverriddenAt" ON "AuditOverrides" ("OverriddenAt");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202174507_AddAuditOverrideEntity') THEN
    CREATE INDEX IF NOT EXISTS "IX_AuditOverrides_OverrideType" ON "AuditOverrides" ("OverrideType");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202174653_AddSoftDeleteToCompanyScopedEntities') THEN
                    ...
                    BEGIN
                        ...
                        CREATE OR REPLACE FUNCTION add_soft_delete_columns(p_tbl text) RETURNS void AS $func$
                        BEGIN
                            IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE information_schema.tables.table_name = p_tbl AND table_schema = 'public') THEN
                                RETURN;
                            END IF;

                            IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE information_schema.columns.table_name = p_tbl AND column_name = 'DeletedAt' AND table_schema = 'public') THEN
                                EXECUTE format('ALTER TABLE %I ADD COLUMN IF NOT EXISTS "DeletedAt" timestamp with time zone', p_tbl);
                            END IF;

                            IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE information_schema.columns.table_name = p_tbl AND column_name = 'DeletedByUserId' AND table_schema = 'public') THEN
                                EXECUTE format('ALTER TABLE %I ADD COLUMN IF NOT EXISTS "DeletedByUserId" uuid', p_tbl);
                            END IF;

                            IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE information_schema.columns.table_name = p_tbl AND column_name = 'IsDeleted' AND table_schema = 'public') THEN
                                EXECUTE format('ALTER TABLE %I ADD COLUMN IF NOT EXISTS "IsDeleted" boolean NOT NULL DEFAULT false', p_tbl);
                            END IF;
                        END;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251202174940_AddRowVersionConcurrencyTokens') THEN
    CREATE INDEX IF NOT EXISTS "IX_OrderReschedules_OrderId" ON "OrderReschedules" ("OrderId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251203001308_AddProcurementSalesProjectEntities') THEN
    CREATE INDEX IF NOT EXISTS "IX_boq_items_ProjectId_LineNumber" ON boq_items ("ProjectId", "LineNumber");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251203001308_AddProcurementSalesProjectEntities') THEN
    CREATE INDEX IF NOT EXISTS "IX_boq_items_ProjectId_Section" ON boq_items ("ProjectId", "Section");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251203001308_AddProcurementSalesProjectEntities') THEN
    CREATE INDEX IF NOT EXISTS "IX_delivery_order_items_DeliveryOrderId_LineNumber" ON delivery_order_items ("DeliveryOrderId", "LineNumber");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251203001308_AddProcurementSalesProjectEntities') THEN
    CREATE INDEX IF NOT EXISTS "IX_delivery_order_items_MaterialId" ON delivery_order_items ("MaterialId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251203001308_AddProcurementSalesProjectEntities') THEN
    CREATE INDEX IF NOT EXISTS "IX_delivery_orders_CompanyId_DoDate" ON delivery_orders ("CompanyId", "DoDate");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251203001308_AddProcurementSalesProjectEntities') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_delivery_orders_CompanyId_DoNumber" ON delivery_orders ("CompanyId", "DoNumber");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251203001308_AddProcurementSalesProjectEntities') THEN
    CREATE INDEX IF NOT EXISTS "IX_delivery_orders_CompanyId_DoType" ON delivery_orders ("CompanyId", "DoType");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251203001308_AddProcurementSalesProjectEntities') THEN
    CREATE INDEX IF NOT EXISTS "IX_delivery_orders_CompanyId_Status" ON delivery_orders ("CompanyId", "Status");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251203001308_AddProcurementSalesProjectEntities') THEN
    CREATE INDEX IF NOT EXISTS "IX_projects_CompanyId_PartnerId" ON projects ("CompanyId", "PartnerId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251203001308_AddProcurementSalesProjectEntities') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_projects_CompanyId_ProjectCode" ON projects ("CompanyId", "ProjectCode");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251203001308_AddProcurementSalesProjectEntities') THEN
    CREATE INDEX IF NOT EXISTS "IX_projects_CompanyId_ProjectType" ON projects ("CompanyId", "ProjectType");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251203001308_AddProcurementSalesProjectEntities') THEN
    CREATE INDEX IF NOT EXISTS "IX_projects_CompanyId_Status" ON projects ("CompanyId", "Status");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251203001308_AddProcurementSalesProjectEntities') THEN
    CREATE INDEX IF NOT EXISTS "IX_purchase_order_items_PurchaseOrderId_LineNumber" ON purchase_order_items ("PurchaseOrderId", "LineNumber");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251203001308_AddProcurementSalesProjectEntities') THEN
    CREATE INDEX IF NOT EXISTS "IX_purchase_orders_CompanyId_PoDate" ON purchase_orders ("CompanyId", "PoDate");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251203001308_AddProcurementSalesProjectEntities') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_purchase_orders_CompanyId_PoNumber" ON purchase_orders ("CompanyId", "PoNumber");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251203001308_AddProcurementSalesProjectEntities') THEN
    CREATE INDEX IF NOT EXISTS "IX_purchase_orders_CompanyId_Status" ON purchase_orders ("CompanyId", "Status");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251203001308_AddProcurementSalesProjectEntities') THEN
    CREATE INDEX IF NOT EXISTS "IX_purchase_orders_CompanyId_SupplierId" ON purchase_orders ("CompanyId", "SupplierId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251203001308_AddProcurementSalesProjectEntities') THEN
    CREATE INDEX IF NOT EXISTS "IX_quotation_items_QuotationId_LineNumber" ON quotation_items ("QuotationId", "LineNumber");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251203001308_AddProcurementSalesProjectEntities') THEN
    CREATE INDEX IF NOT EXISTS "IX_quotations_CompanyId_PartnerId" ON quotations ("CompanyId", "PartnerId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251203001308_AddProcurementSalesProjectEntities') THEN
    CREATE INDEX IF NOT EXISTS "IX_quotations_CompanyId_QuotationDate" ON quotations ("CompanyId", "QuotationDate");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251203001308_AddProcurementSalesProjectEntities') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_quotations_CompanyId_QuotationNumber" ON quotations ("CompanyId", "QuotationNumber");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251203001308_AddProcurementSalesProjectEntities') THEN
    CREATE INDEX IF NOT EXISTS "IX_quotations_CompanyId_Status" ON quotations ("CompanyId", "Status");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251203001308_AddProcurementSalesProjectEntities') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_suppliers_CompanyId_Code" ON suppliers ("CompanyId", "Code");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251203001308_AddProcurementSalesProjectEntities') THEN
    CREATE INDEX IF NOT EXISTS "IX_suppliers_CompanyId_Name" ON suppliers ("CompanyId", "Name");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251204111940_AddSmsAndWhatsAppTemplates') THEN
    CREATE INDEX IF NOT EXISTS "IX_sms_templates_company_id_category_is_active" ON sms_templates (company_id, category, is_active);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251204111940_AddSmsAndWhatsAppTemplates') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_sms_templates_company_id_code" ON sms_templates (company_id, code) WHERE is_deleted = false;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251204111940_AddSmsAndWhatsAppTemplates') THEN
    CREATE INDEX IF NOT EXISTS "IX_sms_templates_company_id_is_active" ON sms_templates (company_id, is_active);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251204111940_AddSmsAndWhatsAppTemplates') THEN
    CREATE INDEX IF NOT EXISTS "IX_whatsapp_templates_company_id_approval_status_is_active" ON whatsapp_templates (company_id, approval_status, is_active);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251204111940_AddSmsAndWhatsAppTemplates') THEN
    CREATE INDEX IF NOT EXISTS "IX_whatsapp_templates_company_id_category_approval_status_is_a~" ON whatsapp_templates (company_id, category, approval_status, is_active);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251204111940_AddSmsAndWhatsAppTemplates') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_whatsapp_templates_company_id_code" ON whatsapp_templates (company_id, code) WHERE is_deleted = false;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251204111940_AddSmsAndWhatsAppTemplates') THEN
    CREATE INDEX IF NOT EXISTS "IX_whatsapp_templates_template_id" ON whatsapp_templates (template_id);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251204122813_AddAllSettingsTables') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_payment_terms_company_id_code" ON payment_terms (company_id, code) WHERE is_deleted = false;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251204122813_AddAllSettingsTables') THEN
    CREATE INDEX IF NOT EXISTS "IX_payment_terms_company_id_is_active" ON payment_terms (company_id, is_active);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251204122813_AddAllSettingsTables') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_tax_codes_company_id_code" ON tax_codes (company_id, code) WHERE is_deleted = false;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251204122813_AddAllSettingsTables') THEN
    CREATE INDEX IF NOT EXISTS "IX_tax_codes_company_id_is_active_is_default" ON tax_codes (company_id, is_active, is_default);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251204122813_AddAllSettingsTables') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_vendors_company_id_code" ON vendors (company_id, code) WHERE is_deleted = false;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251204122813_AddAllSettingsTables') THEN
    CREATE INDEX IF NOT EXISTS "IX_vendors_company_id_is_active" ON vendors (company_id, is_active);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251206140750_AddNetworkInfoAndVoipFields') THEN
    CREATE TABLE IF NOT EXISTS "OrderMaterialReplacements" (
        "Id" uuid NOT NULL,
        "OrderId" uuid NOT NULL,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251206140750_AddNetworkInfoAndVoipFields') THEN
    CREATE TABLE IF NOT EXISTS "OrderNonSerialisedReplacements" (
        "Id" uuid NOT NULL,
        "OrderId" uuid NOT NULL,
        "MaterialId" uuid NOT NULL,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251206140750_AddNetworkInfoAndVoipFields') THEN
    CREATE INDEX IF NOT EXISTS "IX_OrderMaterialReplacements_CompanyId_OrderId" ON "OrderMaterialReplacements" ("CompanyId", "OrderId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251206140750_AddNetworkInfoAndVoipFields') THEN
    CREATE INDEX IF NOT EXISTS "IX_OrderMaterialReplacements_NewMaterialId" ON "OrderMaterialReplacements" ("NewMaterialId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251206140750_AddNetworkInfoAndVoipFields') THEN
    CREATE INDEX IF NOT EXISTS "IX_OrderMaterialReplacements_NewSerialisedItemId" ON "OrderMaterialReplacements" ("NewSerialisedItemId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251206140750_AddNetworkInfoAndVoipFields') THEN
    CREATE INDEX IF NOT EXISTS "IX_OrderMaterialReplacements_OldMaterialId" ON "OrderMaterialReplacements" ("OldMaterialId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251206140750_AddNetworkInfoAndVoipFields') THEN
    CREATE INDEX IF NOT EXISTS "IX_OrderMaterialReplacements_OldSerialisedItemId" ON "OrderMaterialReplacements" ("OldSerialisedItemId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251206140750_AddNetworkInfoAndVoipFields') THEN
    CREATE INDEX IF NOT EXISTS "IX_OrderMaterialReplacements_OrderId" ON "OrderMaterialReplacements" ("OrderId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251206140750_AddNetworkInfoAndVoipFields') THEN
    CREATE INDEX IF NOT EXISTS "IX_OrderMaterialReplacements_RmaRequestId" ON "OrderMaterialReplacements" ("RmaRequestId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251206140750_AddNetworkInfoAndVoipFields') THEN
    CREATE INDEX IF NOT EXISTS "IX_OrderNonSerialisedReplacements_CompanyId_OrderId" ON "OrderNonSerialisedReplacements" ("CompanyId", "OrderId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251206140750_AddNetworkInfoAndVoipFields') THEN
    CREATE INDEX IF NOT EXISTS "IX_OrderNonSerialisedReplacements_MaterialId" ON "OrderNonSerialisedReplacements" ("MaterialId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251206140750_AddNetworkInfoAndVoipFields') THEN
    CREATE INDEX IF NOT EXISTS "IX_OrderNonSerialisedReplacements_OrderId" ON "OrderNonSerialisedReplacements" ("OrderId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251207114421_AddGuardConditionAndSideEffectDefinitions') THEN
    CREATE INDEX IF NOT EXISTS "IX_guard_condition_definitions_company_id_entity_type_is_active" ON guard_condition_definitions (company_id, entity_type, is_active);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251207114421_AddGuardConditionAndSideEffectDefinitions') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_guard_condition_definitions_company_id_entity_type_key" ON guard_condition_definitions (company_id, entity_type, key) WHERE is_deleted = false;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251207114421_AddGuardConditionAndSideEffectDefinitions') THEN
    CREATE INDEX IF NOT EXISTS "IX_side_effect_definitions_company_id_entity_type_is_active" ON side_effect_definitions (company_id, entity_type, is_active);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251207114421_AddGuardConditionAndSideEffectDefinitions') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_side_effect_definitions_company_id_entity_type_key" ON side_effect_definitions (company_id, entity_type, key) WHERE is_deleted = false;
    END IF;
END $EF$;
...
BEGIN
    ...
    CREATE TABLE IF NOT EXISTS "OrderStatusChecklistItems" (
        "Id" uuid NOT NULL,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251207154424_AddOrderStatusChecklist') THEN
    CREATE TABLE IF NOT EXISTS "OrderStatusChecklistAnswers" (
        "Id" uuid NOT NULL,
        "OrderId" uuid NOT NULL,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251207154424_AddOrderStatusChecklist') THEN
    CREATE INDEX IF NOT EXISTS "IX_OrderStatusChecklistAnswers_ChecklistItemId" ON "OrderStatusChecklistAnswers" ("ChecklistItemId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251207154424_AddOrderStatusChecklist') THEN
    CREATE INDEX IF NOT EXISTS "IX_OrderStatusChecklistAnswers_CompanyId_OrderId" ON "OrderStatusChecklistAnswers" ("CompanyId", "OrderId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251207154424_AddOrderStatusChecklist') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_OrderStatusChecklistAnswers_OrderId_ChecklistItemId" ON "OrderStatusChecklistAnswers" ("OrderId", "ChecklistItemId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251207154424_AddOrderStatusChecklist') THEN
    CREATE INDEX IF NOT EXISTS "IX_OrderStatusChecklistItems_CompanyId_StatusCode_IsActive" ON "OrderStatusChecklistItems" ("CompanyId", "StatusCode", "IsActive");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251207154424_AddOrderStatusChecklist') THEN
    CREATE INDEX IF NOT EXISTS "IX_OrderStatusChecklistItems_ParentChecklistItemId" ON "OrderStatusChecklistItems" ("ParentChecklistItemId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251207154424_AddOrderStatusChecklist') THEN
    CREATE INDEX IF NOT EXISTS "IX_OrderStatusChecklistItems_StatusCode_OrderIndex" ON "OrderStatusChecklistItems" ("StatusCode", "OrderIndex");
    END IF;
END $EF$;
...
BEGIN
    ...
    CREATE INDEX IF NOT EXISTS "IX_OrderMaterialUsage_MaterialId" ON "OrderMaterialUsage" ("MaterialId");
    END IF;
END $EF$;
    ...
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251208072755_AddScheduledSlotWorkflowFields') THEN
                    ...
                    BEGIN
                        IF NOT EXISTS (
                            ...
                            ALTER TABLE "ScheduledSlots" ADD COLUMN IF NOT EXISTS "ConfirmedByUserId" uuid NULL;
                        END IF;
                    END $$;
    ...
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251208072755_AddScheduledSlotWorkflowFields') THEN
                    ...
                    BEGIN
                        IF NOT EXISTS (
                            ...
                            ALTER TABLE "ScheduledSlots" ADD COLUMN IF NOT EXISTS "ConfirmedAt" timestamp with time zone NULL;
                        END IF;
                    END $$;
    ...
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251208072755_AddScheduledSlotWorkflowFields') THEN
                    ...
                    BEGIN
                        IF NOT EXISTS (
                            ...
                            ALTER TABLE "ScheduledSlots" ADD COLUMN IF NOT EXISTS "PostedByUserId" uuid NULL;
                        END IF;
                    END $$;
    ...
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251208072755_AddScheduledSlotWorkflowFields') THEN
                    ...
                    BEGIN
                        IF NOT EXISTS (
                            ...
                            ALTER TABLE "ScheduledSlots" ADD COLUMN IF NOT EXISTS "PostedAt" timestamp with time zone NULL;
                        END IF;
                    END $$;
    ...
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251208072755_AddScheduledSlotWorkflowFields') THEN
                    ...
                    BEGIN
                        IF NOT EXISTS (
                            ...
                            ALTER TABLE "ScheduledSlots" ADD COLUMN IF NOT EXISTS "RescheduleRequestedDate" timestamp with time zone NULL;
                        END IF;
                    END $$;
    ...
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251208072755_AddScheduledSlotWorkflowFields') THEN
                    ...
                    BEGIN
                        IF NOT EXISTS (
                            ...
                            ALTER TABLE "ScheduledSlots" ADD COLUMN IF NOT EXISTS "RescheduleRequestedTime" interval NULL;
                        END IF;
                    END $$;
    ...
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251208072755_AddScheduledSlotWorkflowFields') THEN
                    ...
                    BEGIN
                        IF NOT EXISTS (
                            ...
                            ALTER TABLE "ScheduledSlots" ADD COLUMN IF NOT EXISTS "RescheduleReason" character varying(500) NULL;
                        END IF;
                    END $$;
    ...
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251208072755_AddScheduledSlotWorkflowFields') THEN
                    ...
                    BEGIN
                        IF NOT EXISTS (
                            ...
                            ALTER TABLE "ScheduledSlots" ADD COLUMN IF NOT EXISTS "RescheduleNotes" character varying(1000) NULL;
                        END IF;
                    END $$;
    ...
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251208072755_AddScheduledSlotWorkflowFields') THEN
                    ...
                    BEGIN
                        IF NOT EXISTS (
                            ...
                            ALTER TABLE "ScheduledSlots" ADD COLUMN IF NOT EXISTS "RescheduleRequestedBySiId" uuid NULL;
                        END IF;
                    END $$;
    ...
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251208072755_AddScheduledSlotWorkflowFields') THEN
                    ...
                    BEGIN
                        IF NOT EXISTS (
                            ...
                            ALTER TABLE "ScheduledSlots" ADD COLUMN IF NOT EXISTS "RescheduleRequestedAt" timestamp with time zone NULL;
                        END IF;
                    END $$;
    ...
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251208075939_AddBarcodeToMaterial') THEN
                    ...
                    BEGIN
                        IF NOT EXISTS (
                            ...
                            ALTER TABLE "Materials" ADD COLUMN IF NOT EXISTS "Barcode" character varying(200) NULL;
                        END IF;
                    END $$;
    ...
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251208075939_AddBarcodeToMaterial') THEN
                    ...
                    BEGIN
                        IF NOT EXISTS (
                            ...
                            CREATE UNIQUE INDEX IF NOT EXISTS "IX_Materials_CompanyId_Barcode" 
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251208083105_AddMovementTypeAndLocationType') THEN
    CREATE INDEX IF NOT EXISTS "IX_StockMovements_MovementTypeId" ON "StockMovements" ("MovementTypeId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251208083105_AddMovementTypeAndLocationType') THEN
    CREATE INDEX IF NOT EXISTS "IX_StockLocations_CompanyId_LocationTypeId" ON "StockLocations" ("CompanyId", "LocationTypeId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251208083105_AddMovementTypeAndLocationType') THEN
    CREATE INDEX IF NOT EXISTS "IX_StockLocations_LocationTypeId" ON "StockLocations" ("LocationTypeId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251208083105_AddMovementTypeAndLocationType') THEN
    CREATE INDEX IF NOT EXISTS "IX_StockLocations_WarehouseId" ON "StockLocations" ("WarehouseId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251208083105_AddMovementTypeAndLocationType') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_LocationTypes_CompanyId_Code" ON "LocationTypes" ("CompanyId", "Code");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251208083105_AddMovementTypeAndLocationType') THEN
    CREATE INDEX IF NOT EXISTS "IX_LocationTypes_CompanyId_IsActive" ON "LocationTypes" ("CompanyId", "IsActive");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251208083105_AddMovementTypeAndLocationType') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_MovementTypes_CompanyId_Code" ON "MovementTypes" ("CompanyId", "Code");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251208083105_AddMovementTypeAndLocationType') THEN
    CREATE INDEX IF NOT EXISTS "IX_MovementTypes_CompanyId_IsActive" ON "MovementTypes" ("CompanyId", "IsActive");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251208084246_AddMaterialTaggingSystem') THEN
    CREATE TABLE IF NOT EXISTS "MaterialVerticals" (
        "Id" uuid NOT NULL,
        "Code" character varying(50) NOT NULL,
        "Name" character varying(200) NOT NULL,
        "Description" text,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251208084246_AddMaterialTaggingSystem') THEN
    CREATE TABLE IF NOT EXISTS "MaterialMaterialTags" (
        "MaterialId" uuid NOT NULL,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251208084246_AddMaterialTaggingSystem') THEN
    CREATE TABLE IF NOT EXISTS "MaterialMaterialVerticals" (
        "MaterialId" uuid NOT NULL,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251208084246_AddMaterialTaggingSystem') THEN
    CREATE INDEX IF NOT EXISTS "IX_Materials_MaterialCategoryId" ON "Materials" ("MaterialCategoryId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251208084246_AddMaterialTaggingSystem') THEN
    CREATE INDEX IF NOT EXISTS "IX_MaterialAttributes_MaterialId" ON "MaterialAttributes" ("MaterialId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251208084246_AddMaterialTaggingSystem') THEN
    CREATE INDEX IF NOT EXISTS "IX_MaterialAttributes_MaterialId_Key" ON "MaterialAttributes" ("MaterialId", "Key");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251208084246_AddMaterialTaggingSystem') THEN
    CREATE INDEX IF NOT EXISTS "IX_MaterialMaterialTags_MaterialTagId" ON "MaterialMaterialTags" ("MaterialTagId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251208084246_AddMaterialTaggingSystem') THEN
    CREATE INDEX IF NOT EXISTS "IX_MaterialMaterialVerticals_MaterialVerticalId" ON "MaterialMaterialVerticals" ("MaterialVerticalId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251208084246_AddMaterialTaggingSystem') THEN
    CREATE INDEX IF NOT EXISTS "IX_MaterialTags_CompanyId_IsActive" ON "MaterialTags" ("CompanyId", "IsActive");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251208084246_AddMaterialTaggingSystem') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_MaterialTags_CompanyId_Name" ON "MaterialTags" ("CompanyId", "Name");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251208084246_AddMaterialTaggingSystem') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_MaterialVerticals_CompanyId_Code" ON "MaterialVerticals" ("CompanyId", "Code");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251208084246_AddMaterialTaggingSystem') THEN
    CREATE INDEX IF NOT EXISTS "IX_MaterialVerticals_CompanyId_IsActive" ON "MaterialVerticals" ("CompanyId", "IsActive");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251209071111_AddCustomerPreferenceTable') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_customer_preferences_customer_phone" ON customer_preferences (customer_phone);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251209071111_AddCustomerPreferenceTable') THEN
    CREATE INDEX IF NOT EXISTS "IX_customer_preferences_last_whatsapp_check" ON customer_preferences (last_whatsapp_check);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251209071111_AddCustomerPreferenceTable') THEN
    CREATE INDEX IF NOT EXISTS "IX_customer_preferences_uses_whatsapp" ON customer_preferences (uses_whatsapp);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251209071111_AddCustomerPreferenceTable') THEN
    CREATE INDEX IF NOT EXISTS "IX_sms_gateways_is_active" ON sms_gateways (is_active) WHERE is_active = true;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251209071111_AddCustomerPreferenceTable') THEN
    CREATE INDEX IF NOT EXISTS "IX_sms_gateways_last_seen_at_utc" ON sms_gateways (last_seen_at_utc);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251210234157_FixModelSnapshot') THEN
    CREATE INDEX IF NOT EXISTS "IX_JobEarningRecords_OrderTypeId" ON "JobEarningRecords" ("OrderTypeId");
    END IF;
END $EF$;
    ...
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251219020647_RenameInstallationTypeToOrderCategory') THEN
                    ...
                    BEGIN
                        ...
                        IF NOT EXISTS (
                            ...
                            ADD COLUMN IF NOT EXISTS "AdditionalContactNumber" character varying(100) NULL;
                        END IF;
                        ...
                        IF NOT EXISTS (
                            ...
                            ALTER TABLE "ParsedOrderDrafts" 
                            ADD COLUMN IF NOT EXISTS "Issue" character varying(1000) NULL;
                        END IF;
                        ...
                        IF NOT EXISTS (
                            ...
                            ALTER TABLE "Orders" 
                            ADD COLUMN IF NOT EXISTS "Solution" character varying(2000) NULL;
                        END IF;
                    END $$;
    ...
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251219020647_RenameInstallationTypeToOrderCategory') THEN
                    ...
                    BEGIN
                        IF NOT EXISTS (
                            ...
                            CREATE INDEX IF NOT EXISTS "IX_Buildings_InstallationMethodId" ON "Buildings" ("InstallationMethodId");
                        END IF;
                    END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260106014539_CapturePendingModelChanges') THEN
    CREATE TABLE IF NOT EXISTS "ServiceInstallerSkills" (
        "Id" uuid NOT NULL,
        "ServiceInstallerId" uuid NOT NULL,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260106014539_CapturePendingModelChanges') THEN
    CREATE INDEX IF NOT EXISTS "IX_ServiceInstallerSkills_ServiceInstallerId" ON "ServiceInstallerSkills" ("ServiceInstallerId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260106014539_CapturePendingModelChanges') THEN
    CREATE INDEX IF NOT EXISTS "IX_ServiceInstallerSkills_ServiceInstallerId_IsActive" ON "ServiceInstallerSkills" ("ServiceInstallerId", "IsActive");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260106014539_CapturePendingModelChanges') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_ServiceInstallerSkills_ServiceInstallerId_SkillId_IsActive" ON "ServiceInstallerSkills" ("ServiceInstallerId", "SkillId", "IsActive") WHERE "IsActive" = true AND "IsDeleted" = false;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260106014539_CapturePendingModelChanges') THEN
    CREATE INDEX IF NOT EXISTS "IX_ServiceInstallerSkills_SkillId" ON "ServiceInstallerSkills" ("SkillId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260106014539_CapturePendingModelChanges') THEN
    CREATE INDEX IF NOT EXISTS "IX_Skills_CompanyId_Category_IsActive" ON "Skills" ("CompanyId", "Category", "IsActive");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260106014539_CapturePendingModelChanges') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_Skills_CompanyId_Code" ON "Skills" ("CompanyId", "Code") WHERE "IsDeleted" = false;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260106072239_AddDepartmentIdToSkills') THEN
    CREATE INDEX IF NOT EXISTS "IX_Skills_CompanyId_DepartmentId_Category_IsActive" ON "Skills" ("CompanyId", "DepartmentId", "Category", "IsActive");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260106072239_AddDepartmentIdToSkills') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_Skills_CompanyId_DepartmentId_Code" ON "Skills" ("CompanyId", "DepartmentId", "Code") WHERE "IsDeleted" = false;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260106072239_AddDepartmentIdToSkills') THEN
    CREATE INDEX IF NOT EXISTS "IX_Skills_DepartmentId" ON "Skills" ("DepartmentId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260203043142_AddAuditLogTable') THEN
    CREATE INDEX IF NOT EXISTS "IX_AuditLogs_CompanyId_EntityType_EntityId" ON "AuditLogs" ("CompanyId", "EntityType", "EntityId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260203043142_AddAuditLogTable') THEN
    CREATE INDEX IF NOT EXISTS "IX_AuditLogs_CompanyId_Timestamp" ON "AuditLogs" ("CompanyId", "Timestamp");
    END IF;
END $EF$;
...
BEGIN
    ...
    CREATE TABLE IF NOT EXISTS "StockAllocations" (
        "Id" uuid NOT NULL,
        "MaterialId" uuid NOT NULL,
        "SerialisedItemId" uuid,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260203063309_AddStockLedgerAndAllocation') THEN
    CREATE INDEX IF NOT EXISTS "IX_StockAllocations_LedgerEntryIdIssued" ON "StockAllocations" ("LedgerEntryIdIssued");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260203063309_AddStockLedgerAndAllocation') THEN
    CREATE INDEX IF NOT EXISTS "IX_StockAllocations_LedgerEntryIdReserved" ON "StockAllocations" ("LedgerEntryIdReserved");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260203063309_AddStockLedgerAndAllocation') THEN
    CREATE INDEX IF NOT EXISTS "IX_StockAllocations_LedgerEntryIdReturned" ON "StockAllocations" ("LedgerEntryIdReturned");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260203063309_AddStockLedgerAndAllocation') THEN
    CREATE INDEX IF NOT EXISTS "IX_StockAllocations_LocationId" ON "StockAllocations" ("LocationId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260203063309_AddStockLedgerAndAllocation') THEN
    CREATE INDEX IF NOT EXISTS "IX_StockAllocations_MaterialId" ON "StockAllocations" ("MaterialId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260203063309_AddStockLedgerAndAllocation') THEN
    CREATE INDEX IF NOT EXISTS "IX_StockAllocations_SerialisedItemId" ON "StockAllocations" ("SerialisedItemId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260203063309_AddStockLedgerAndAllocation') THEN
    CREATE INDEX IF NOT EXISTS "IX_StockLedgerEntries_AllocationId" ON "StockLedgerEntries" ("AllocationId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260203063309_AddStockLedgerAndAllocation') THEN
    CREATE INDEX IF NOT EXISTS "IX_StockLedgerEntries_FromLocationId" ON "StockLedgerEntries" ("FromLocationId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260203063309_AddStockLedgerAndAllocation') THEN
    CREATE INDEX IF NOT EXISTS "IX_StockLedgerEntries_LocationId" ON "StockLedgerEntries" ("LocationId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260203063309_AddStockLedgerAndAllocation') THEN
    CREATE INDEX IF NOT EXISTS "IX_StockLedgerEntries_MaterialId" ON "StockLedgerEntries" ("MaterialId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260203063309_AddStockLedgerAndAllocation') THEN
    CREATE INDEX IF NOT EXISTS "IX_StockLedgerEntries_SerialisedItemId" ON "StockLedgerEntries" ("SerialisedItemId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260203063309_AddStockLedgerAndAllocation') THEN
    CREATE INDEX IF NOT EXISTS "IX_StockLedgerEntries_ToLocationId" ON "StockLedgerEntries" ("ToLocationId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260203082321_AddLedgerReadPerformanceIndexes') THEN
    CREATE INDEX IF NOT EXISTS "IX_StockLedgerEntries_CompanyId_IsDeleted_CreatedAt" ON "StockLedgerEntries" ("CompanyId", "IsDeleted", "CreatedAt" DESC);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260203082321_AddLedgerReadPerformanceIndexes') THEN
    CREATE INDEX IF NOT EXISTS "IX_StockLedgerEntries_CompanyId_IsDeleted_MaterialId_LocationId" ON "StockLedgerEntries" ("CompanyId", "IsDeleted", "MaterialId", "LocationId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260203082321_AddLedgerReadPerformanceIndexes') THEN
    CREATE INDEX IF NOT EXISTS "IX_StockLedgerEntries_CompanyId_IsDeleted_OrderId" ON "StockLedgerEntries" ("CompanyId", "IsDeleted", "OrderId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260203082321_AddLedgerReadPerformanceIndexes') THEN
    CREATE INDEX IF NOT EXISTS "IX_StockLedgerEntries_SerialisedItemId_CreatedAt" ON "StockLedgerEntries" ("SerialisedItemId", "CreatedAt");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260203082321_AddLedgerReadPerformanceIndexes') THEN
    CREATE INDEX IF NOT EXISTS "IX_StockAllocations_CompanyId_IsDeleted_Status" ON "StockAllocations" ("CompanyId", "IsDeleted", "Status");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260203082321_AddLedgerReadPerformanceIndexes') THEN
    CREATE INDEX IF NOT EXISTS "IX_StockAllocations_MaterialId_LocationId_Status" ON "StockAllocations" ("MaterialId", "LocationId", "Status");
    END IF;
END $EF$;
...
BEGIN
    ...
    CREATE TABLE IF NOT EXISTS "LedgerBalanceCaches" (
        "Id" uuid NOT NULL,
        "CompanyId" uuid,
        "MaterialId" uuid NOT NULL,
        "LocationId" uuid NOT NULL,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260203082947_AddLedgerBalanceCache') THEN
    CREATE INDEX IF NOT EXISTS "IX_LedgerBalanceCaches_CompanyId_DepartmentId" ON "LedgerBalanceCaches" ("CompanyId", "DepartmentId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260203082947_AddLedgerBalanceCache') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_LedgerBalanceCaches_CompanyId_MaterialId_LocationId" ON "LedgerBalanceCaches" ("CompanyId", "MaterialId", "LocationId");
    END IF;
END $EF$;
...
BEGIN
    ...
    CREATE TABLE IF NOT EXISTS "StockByLocationSnapshots" (
        "Id" uuid NOT NULL,
        "CompanyId" uuid NOT NULL,
        "DepartmentId" uuid,
        "MaterialId" uuid NOT NULL,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260203093328_AddStockByLocationSnapshots') THEN
    CREATE INDEX IF NOT EXISTS "IX_StockByLocationSnapshots_CompanyId_DepartmentId_Period_Type" ON "StockByLocationSnapshots" ("CompanyId", "DepartmentId", "PeriodStart", "SnapshotType");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260203093328_AddStockByLocationSnapshots') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_StockByLocationSnapshots_CompanyId_MaterialId_LocationId_PeriodStart_Type" ON "StockByLocationSnapshots" ("CompanyId", "MaterialId", "LocationId", "PeriodStart", "SnapshotType");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260308102000_AddOrderFinancialAlerts') THEN
    CREATE TABLE IF NOT EXISTS "OrderFinancialAlerts" (
        "Id" uuid NOT NULL,
        "OrderId" uuid NOT NULL,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260308102000_AddOrderFinancialAlerts') THEN
    CREATE INDEX IF NOT EXISTS "IX_OrderFinancialAlerts_CompanyId" ON "OrderFinancialAlerts" ("CompanyId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260308102000_AddOrderFinancialAlerts') THEN
    CREATE INDEX IF NOT EXISTS "IX_OrderFinancialAlerts_CreatedAt" ON "OrderFinancialAlerts" ("CreatedAt");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260308102000_AddOrderFinancialAlerts') THEN
    CREATE INDEX IF NOT EXISTS "IX_OrderFinancialAlerts_IsActive" ON "OrderFinancialAlerts" ("IsActive");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260308102000_AddOrderFinancialAlerts') THEN
    CREATE INDEX IF NOT EXISTS "IX_OrderFinancialAlerts_OrderId_AlertCode" ON "OrderFinancialAlerts" ("OrderId", "AlertCode");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260308133701_AddServiceProfiles') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_ServiceProfiles_CompanyId_Code" ON "ServiceProfiles" ("CompanyId", "Code") WHERE "IsDeleted" = false;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260308133701_AddServiceProfiles') THEN
    CREATE INDEX IF NOT EXISTS "IX_ServiceProfiles_CompanyId_IsActive" ON "ServiceProfiles" ("CompanyId", "IsActive") WHERE "IsDeleted" = false;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260308133701_AddServiceProfiles') THEN
    CREATE TABLE IF NOT EXISTS "OrderCategoryServiceProfiles" (
        "Id" uuid NOT NULL,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260308133701_AddServiceProfiles') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_OrderCategoryServiceProfiles_CompanyId_OrderCategoryId" ON "OrderCategoryServiceProfiles" ("CompanyId", "OrderCategoryId") WHERE "IsDeleted" = false;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260308133701_AddServiceProfiles') THEN
    CREATE INDEX IF NOT EXISTS "IX_OrderCategoryServiceProfiles_OrderCategoryId" ON "OrderCategoryServiceProfiles" ("OrderCategoryId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260308133701_AddServiceProfiles') THEN
    CREATE INDEX IF NOT EXISTS "IX_OrderCategoryServiceProfiles_ServiceProfileId" ON "OrderCategoryServiceProfiles" ("ServiceProfileId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260308134742_AddServiceProfileIdToBaseWorkRate') THEN
    CREATE INDEX IF NOT EXISTS "IX_BaseWorkRates_ServiceProfileId" ON "BaseWorkRates" ("ServiceProfileId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260308134742_AddServiceProfileIdToBaseWorkRate') THEN
    CREATE INDEX IF NOT EXISTS "IX_BaseWorkRates_ServiceProfileLookup" ON "BaseWorkRates" ("RateGroupId", "ServiceProfileId", "InstallationMethodId", "OrderSubtypeId") WHERE "IsDeleted" = false AND "IsActive" = true;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260308193638_AddEventBusCorrelationAndEventStore') THEN
    CREATE INDEX IF NOT EXISTS "IX_EventStore_CompanyId_EventType_OccurredAtUtc" ON "EventStore" ("CompanyId", "EventType", "OccurredAtUtc");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260308193638_AddEventBusCorrelationAndEventStore') THEN
    CREATE INDEX IF NOT EXISTS "IX_EventStore_CorrelationId" ON "EventStore" ("CorrelationId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260308193638_AddEventBusCorrelationAndEventStore') THEN
    CREATE INDEX IF NOT EXISTS "IX_EventStore_Status" ON "EventStore" ("Status");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260308194528_ExtendEventStorePhase2') THEN
    CREATE INDEX IF NOT EXISTS "IX_EventStore_OccurredAtUtc" ON "EventStore" ("OccurredAtUtc");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260308204750_AddSlaRulesTable') THEN
    CREATE INDEX IF NOT EXISTS "IX_SlaRules_CompanyId" ON "SlaRules" ("CompanyId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260308204750_AddSlaRulesTable') THEN
    CREATE INDEX IF NOT EXISTS "IX_SlaRules_CompanyId_Enabled_RuleType" ON "SlaRules" ("CompanyId", "Enabled", "RuleType");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260308204750_AddSlaRulesTable') THEN
    CREATE INDEX IF NOT EXISTS "IX_SlaRules_CompanyId_TargetType_TargetName" ON "SlaRules" ("CompanyId", "TargetType", "TargetName");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260308204838_AddSlaBreachesTable') THEN
    CREATE INDEX IF NOT EXISTS "IX_SlaBreaches_CompanyId" ON "SlaBreaches" ("CompanyId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260308204838_AddSlaBreachesTable') THEN
    CREATE INDEX IF NOT EXISTS "IX_SlaBreaches_CompanyId_Severity" ON "SlaBreaches" ("CompanyId", "Severity");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260308204838_AddSlaBreachesTable') THEN
    CREATE INDEX IF NOT EXISTS "IX_SlaBreaches_CompanyId_Status_DetectedAtUtc" ON "SlaBreaches" ("CompanyId", "Status", "DetectedAtUtc");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260308204838_AddSlaBreachesTable') THEN
    CREATE INDEX IF NOT EXISTS "IX_SlaBreaches_CorrelationId" ON "SlaBreaches" ("CorrelationId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260308204838_AddSlaBreachesTable') THEN
    CREATE INDEX IF NOT EXISTS "IX_SlaBreaches_RuleId" ON "SlaBreaches" ("RuleId");
    END IF;
END $EF$;
...
BEGIN
    ...
    CREATE TABLE IF NOT EXISTS "WorkflowTransitionHistory" (
        "EventId" uuid NOT NULL,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260308214936_AddWorkflowTransitionHistory') THEN
    CREATE INDEX IF NOT EXISTS "IX_WorkflowTransitionHistory_CompanyId_EntityType_EntityId" ON "WorkflowTransitionHistory" ("CompanyId", "EntityType", "EntityId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260308214936_AddWorkflowTransitionHistory') THEN
    CREATE INDEX IF NOT EXISTS "IX_WorkflowTransitionHistory_OccurredAtUtc" ON "WorkflowTransitionHistory" ("OccurredAtUtc");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309013846_AddEventLedgerEntries') THEN
    CREATE INDEX IF NOT EXISTS "IX_LedgerEntries_CompanyId_LedgerFamily_OccurredAtUtc" ON "LedgerEntries" ("CompanyId", "LedgerFamily", "OccurredAtUtc");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309013846_AddEventLedgerEntries') THEN
    CREATE INDEX IF NOT EXISTS "IX_LedgerEntries_EntityType_EntityId_LedgerFamily" ON "LedgerEntries" ("EntityType", "EntityId", "LedgerFamily");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309013846_AddEventLedgerEntries') THEN
    CREATE INDEX IF NOT EXISTS "IX_LedgerEntries_RecordedAtUtc" ON "LedgerEntries" ("RecordedAtUtc");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309013846_AddEventLedgerEntries') THEN
    CREATE INDEX IF NOT EXISTS "IX_LedgerEntries_ReplayOperationId" ON "LedgerEntries" ("ReplayOperationId") WHERE "ReplayOperationId" IS NOT NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309013846_AddEventLedgerEntries') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_LedgerEntries_ReplayOperationId_LedgerFamily" ON "LedgerEntries" ("ReplayOperationId", "LedgerFamily") WHERE "ReplayOperationId" IS NOT NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309013846_AddEventLedgerEntries') THEN
    CREATE INDEX IF NOT EXISTS "IX_LedgerEntries_SourceEventId" ON "LedgerEntries" ("SourceEventId") WHERE "SourceEventId" IS NOT NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309013846_AddEventLedgerEntries') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_LedgerEntries_SourceEventId_LedgerFamily" ON "LedgerEntries" ("SourceEventId", "LedgerFamily") WHERE "SourceEventId" IS NOT NULL;
    END IF;
END $EF$;
...
BEGIN
    ...
    CREATE TABLE IF NOT EXISTS "EventProcessingLog" (
        "Id" uuid NOT NULL,
        "EventId" uuid NOT NULL,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309025207_AddEventProcessingLog') THEN
    CREATE INDEX IF NOT EXISTS "IX_EventProcessingLog_EventId" ON "EventProcessingLog" ("EventId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309025207_AddEventProcessingLog') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_EventProcessingLog_EventId_HandlerName" ON "EventProcessingLog" ("EventId", "HandlerName");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309025207_AddEventProcessingLog') THEN
    CREATE INDEX IF NOT EXISTS "IX_EventProcessingLog_ReplayOperationId" ON "EventProcessingLog" ("ReplayOperationId") WHERE "ReplayOperationId" IS NOT NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309025207_AddEventProcessingLog') THEN
    CREATE INDEX IF NOT EXISTS "IX_EventProcessingLog_State_StartedAtUtc" ON "EventProcessingLog" ("State", "StartedAtUtc");
    END IF;
END $EF$;
...
BEGIN
    ...
    CREATE TABLE IF NOT EXISTS "ReplayExecutionLock" (
        "Id" uuid NOT NULL,
        "CompanyId" uuid NOT NULL,
        "ReplayOperationId" uuid NOT NULL,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309030727_AddReplayExecutionLock') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_ReplayExecutionLock_CompanyId" ON "ReplayExecutionLock" ("CompanyId") WHERE "ReleasedAtUtc" IS NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309030727_AddReplayExecutionLock') THEN
    CREATE INDEX IF NOT EXISTS "IX_ReplayExecutionLock_ReleasedAtUtc" ON "ReplayExecutionLock" ("ReleasedAtUtc");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309030727_AddReplayExecutionLock') THEN
    CREATE INDEX IF NOT EXISTS "IX_ReplayExecutionLock_ReplayOperationId" ON "ReplayExecutionLock" ("ReplayOperationId");
    END IF;
END $EF$;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309044417_AddRebuildOperations') THEN
    CREATE TABLE IF NOT EXISTS "RebuildOperations" (
        "Id" uuid NOT NULL,
        "RebuildTargetId" character varying(128) NOT NULL,
        "RequestedByUserId" uuid,
        "RequestedAtUtc" timestamp with time zone NOT NULL,
        "ScopeCompanyId" uuid,
        "FromOccurredAtUtc" timestamp with time zone,
        "ToOccurredAtUtc" timestamp with time zone,
        "DryRun" boolean NOT NULL,
        "State" character varying(50) NOT NULL,
        ...
        "ErrorMessage" character varying(2000),
        "Notes" character varying(2000),
        CONSTRAINT "PK_RebuildOperations" PRIMARY KEY ("Id")
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309044417_AddRebuildOperations') THEN
    CREATE INDEX IF NOT EXISTS "IX_RebuildOperations_RebuildTargetId" ON "RebuildOperations" ("RebuildTargetId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309044417_AddRebuildOperations') THEN
    CREATE INDEX IF NOT EXISTS "IX_RebuildOperations_RequestedAtUtc" ON "RebuildOperations" ("RequestedAtUtc");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309044417_AddRebuildOperations') THEN
    CREATE INDEX IF NOT EXISTS "IX_RebuildOperations_ScopeCompanyId_RequestedAtUtc" ON "RebuildOperations" ("ScopeCompanyId", "RequestedAtUtc");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309044417_AddRebuildOperations') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260309044417_AddRebuildOperations', '10.0.3');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309050021_RebuildPhase2CheckpointAndLock') THEN
    ALTER TABLE "RebuildOperations" ADD "BackgroundJobId" uuid;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309050021_RebuildPhase2CheckpointAndLock') THEN
    ALTER TABLE "RebuildOperations" ADD "CheckpointCount" integer NOT NULL DEFAULT 0;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309050021_RebuildPhase2CheckpointAndLock') THEN
    ALTER TABLE "RebuildOperations" ADD "LastCheckpointAtUtc" timestamp with time zone;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309050021_RebuildPhase2CheckpointAndLock') THEN
    ALTER TABLE "RebuildOperations" ADD "LastProcessedEventId" uuid;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309050021_RebuildPhase2CheckpointAndLock') THEN
    ALTER TABLE "RebuildOperations" ADD "LastProcessedOccurredAtUtc" timestamp with time zone;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309050021_RebuildPhase2CheckpointAndLock') THEN
    ALTER TABLE "RebuildOperations" ADD "ProcessedCountAtLastCheckpoint" integer NOT NULL DEFAULT 0;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309050021_RebuildPhase2CheckpointAndLock') THEN
    ALTER TABLE "RebuildOperations" ADD "RerunReason" character varying(500);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309050021_RebuildPhase2CheckpointAndLock') THEN
    ALTER TABLE "RebuildOperations" ADD "ResumeRequired" boolean NOT NULL DEFAULT FALSE;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309050021_RebuildPhase2CheckpointAndLock') THEN
    ALTER TABLE "RebuildOperations" ADD "RetriedFromOperationId" uuid;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309050021_RebuildPhase2CheckpointAndLock') THEN
    CREATE TABLE IF NOT EXISTS "RebuildExecutionLocks" (
        "Id" uuid NOT NULL,
        "RebuildTargetId" character varying(128) NOT NULL,
        "ScopeKey" character varying(64) NOT NULL,
        "RebuildOperationId" uuid NOT NULL,
        "AcquiredAtUtc" timestamp with time zone NOT NULL,
        "ExpiresAtUtc" timestamp with time zone,
        "ReleasedAtUtc" timestamp with time zone,
        CONSTRAINT "PK_RebuildExecutionLocks" PRIMARY KEY ("Id")
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309050021_RebuildPhase2CheckpointAndLock') THEN
    CREATE INDEX IF NOT EXISTS "IX_RebuildOperations_BackgroundJobId" ON "RebuildOperations" ("BackgroundJobId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309050021_RebuildPhase2CheckpointAndLock') THEN
    CREATE INDEX IF NOT EXISTS "IX_RebuildOperations_State_RequestedAtUtc" ON "RebuildOperations" ("State", "RequestedAtUtc");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309050021_RebuildPhase2CheckpointAndLock') THEN
    CREATE INDEX IF NOT EXISTS "IX_RebuildExecutionLocks_RebuildOperationId" ON "RebuildExecutionLocks" ("RebuildOperationId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309050021_RebuildPhase2CheckpointAndLock') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_RebuildExecutionLocks_RebuildTargetId_ScopeKey" ON "RebuildExecutionLocks" ("RebuildTargetId", "ScopeKey") WHERE "ReleasedAtUtc" IS NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309050021_RebuildPhase2CheckpointAndLock') THEN
    CREATE INDEX IF NOT EXISTS "IX_RebuildExecutionLocks_ReleasedAtUtc" ON "RebuildExecutionLocks" ("ReleasedAtUtc");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309050021_RebuildPhase2CheckpointAndLock') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260309050021_RebuildPhase2CheckpointAndLock', '10.0.3');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309051147_AddWorkerInstancesAndJobOwnership') THEN
    ALTER TABLE "ReplayOperations" ADD "ClaimedAtUtc" timestamp with time zone;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309051147_AddWorkerInstancesAndJobOwnership') THEN
    ALTER TABLE "ReplayOperations" ADD "WorkerId" uuid;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309051147_AddWorkerInstancesAndJobOwnership') THEN
    ALTER TABLE "RebuildOperations" ADD "ClaimedAtUtc" timestamp with time zone;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309051147_AddWorkerInstancesAndJobOwnership') THEN
    ALTER TABLE "RebuildOperations" ADD "WorkerId" uuid;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309051147_AddWorkerInstancesAndJobOwnership') THEN
    CREATE TABLE IF NOT EXISTS "WorkerInstances" (
        "Id" uuid NOT NULL,
        ...
        "IsActive" boolean NOT NULL,
        CONSTRAINT "PK_WorkerInstances" PRIMARY KEY ("Id")
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309051147_AddWorkerInstancesAndJobOwnership') THEN
    CREATE INDEX IF NOT EXISTS "IX_ReplayOperations_WorkerId" ON "ReplayOperations" ("WorkerId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309051147_AddWorkerInstancesAndJobOwnership') THEN
    CREATE INDEX IF NOT EXISTS "IX_RebuildOperations_WorkerId" ON "RebuildOperations" ("WorkerId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309051147_AddWorkerInstancesAndJobOwnership') THEN
    CREATE INDEX IF NOT EXISTS "IX_WorkerInstances_IsActive_LastHeartbeatUtc" ON "WorkerInstances" ("IsActive", "LastHeartbeatUtc");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309051147_AddWorkerInstancesAndJobOwnership') THEN
    CREATE INDEX IF NOT EXISTS "IX_WorkerInstances_LastHeartbeatUtc" ON "WorkerInstances" ("LastHeartbeatUtc");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309051147_AddWorkerInstancesAndJobOwnership') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260309051147_AddWorkerInstancesAndJobOwnership', '10.0.3');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309053019_AddBackgroundJobWorkerOwnership') THEN
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309053019_AddBackgroundJobWorkerOwnership') THEN
    ALTER TABLE "BackgroundJobs" ADD "ClaimedAtUtc" timestamp with time zone;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309053019_AddBackgroundJobWorkerOwnership') THEN
    ALTER TABLE "BackgroundJobs" ADD "WorkerId" uuid;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309053019_AddBackgroundJobWorkerOwnership') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260309053019_AddBackgroundJobWorkerOwnership', '10.0.3');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309060310_AddOrderIdToTaskItem') THEN
    ALTER TABLE "TaskItems" ADD "OrderId" uuid;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309060310_AddOrderIdToTaskItem') THEN
    CREATE INDEX IF NOT EXISTS "IX_TaskItems_CompanyId_OrderId" ON "TaskItems" ("CompanyId", "OrderId") WHERE "OrderId" IS NOT NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309060310_AddOrderIdToTaskItem') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260309060310_AddOrderIdToTaskItem', '10.0.3');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309065620_PendingModelCheck') THEN
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309065620_PendingModelCheck') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260309065620_PendingModelCheck', '10.0.3');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309065950_VerifyNoPending') THEN
    ALTER TABLE "EventStore" ADD "LastClaimedAtUtc" timestamp with time zone;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309065950_VerifyNoPending') THEN
    ALTER TABLE "EventStore" ADD "LastClaimedBy" character varying(200);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309065950_VerifyNoPending') THEN
    ALTER TABLE "EventStore" ADD "LastErrorType" character varying(100);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309065950_VerifyNoPending') THEN
    ALTER TABLE "EventStore" ADD "ProcessingLeaseExpiresAtUtc" timestamp with time zone;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309065950_VerifyNoPending') THEN
    ALTER TABLE "EventStore" ADD "ProcessingNodeId" character varying(200);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309065950_VerifyNoPending') THEN
    ALTER TABLE "EventStore" ADD "ProcessingStartedAtUtc" timestamp with time zone;
    END IF;
END $EF$;
...
BEGIN
    ...
    CREATE TABLE IF NOT EXISTS "EventStoreAttemptHistory" (
        ...
        "ErrorMessage" character varying(2000),
        "StackTraceSummary" character varying(2000),
        "WasRetried" boolean NOT NULL,
        "WasDeadLettered" boolean NOT NULL,
        CONSTRAINT "PK_EventStoreAttemptHistory" PRIMARY KEY ("Id")
    );
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309065950_VerifyNoPending') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260309065950_VerifyNoPending', '10.0.3');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309070232_SyncSnapshotCheck') THEN
    ALTER TABLE "TaskItems" ADD "OrderId" uuid;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309070232_SyncSnapshotCheck') THEN
    ALTER TABLE "ParsedOrderDrafts" ADD "OrderCategoryId" uuid;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309070232_SyncSnapshotCheck') THEN
    ALTER TABLE "ParsedOrderDrafts" ADD "UnmatchedMaterialCount" integer;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309070232_SyncSnapshotCheck') THEN
    ALTER TABLE "ParsedOrderDrafts" ADD "UnmatchedMaterialNamesJson" text;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309070232_SyncSnapshotCheck') THEN
    CREATE TABLE IF NOT EXISTS "ParsedMaterialAliases" (
        "Id" uuid NOT NULL,
        ...
        "DeletedByUserId" uuid,
        "RowVersion" bytea,
        CONSTRAINT "PK_ParsedMaterialAliases" PRIMARY KEY ("Id")
    );
    END IF;
END $EF$;
...
BEGIN
    ...
    CREATE TABLE IF NOT EXISTS "RebuildOperations" (
        ...
        "LastCheckpointAtUtc" timestamp with time zone,
        "LastProcessedEventId" uuid,
        "LastProcessedOccurredAtUtc" timestamp with time zone,
        "ProcessedCountAtLastCheckpoint" integer NOT NULL,
        "CheckpointCount" integer NOT NULL,
        "RetriedFromOperationId" uuid,
        "RerunReason" character varying(500),
        "WorkerId" uuid,
...
BEGIN
    ...
    CREATE TABLE IF NOT EXISTS "ReplayOperationEvents" (
        ...
        "Succeeded" boolean NOT NULL,
        "ErrorMessage" character varying(2000),
        "SkippedReason" character varying(500),
        "ProcessedAtUtc" timestamp with time zone NOT NULL,
        "DurationMs" bigint,
        CONSTRAINT "PK_ReplayOperationEvents" PRIMARY KEY ("Id")
    );
...
BEGIN
    ...
    CREATE TABLE IF NOT EXISTS "ReplayOperations" (
        ...
        "RequestedAtUtc" timestamp with time zone NOT NULL,
        "DryRun" boolean NOT NULL,
        "ReplayReason" character varying(2000),
        "CompanyId" uuid,
        "EventType" character varying(200),
        ...
        "TotalFailed" integer,
        "ReplayCorrelationId" character varying(200),
        "Notes" character varying(4000),
        "State" character varying(50),
        "CompletedAtUtc" timestamp with time zone,
        "ReplayTarget" character varying(50),
        "ReplayMode" character varying(50),
        "StartedAtUtc" timestamp with time zone,
        "DurationMs" bigint,
        ...
        "LastProcessedOccurredAtUtc" timestamp with time zone,
        "CheckpointCount" integer NOT NULL,
        "ProcessedCountAtLastCheckpoint" integer,
        "OrderingStrategyId" character varying(100),
        "RetriedFromOperationId" uuid,
        "RerunReason" character varying(500),
        "CancelRequestedAtUtc" timestamp with time zone,
        "SafetyCutoffOccurredAtUtc" timestamp with time zone,
        "SafetyWindowMinutes" integer,
        "WorkerId" uuid,
        "ClaimedAtUtc" timestamp with time zone,
        CONSTRAINT "PK_ReplayOperations" PRIMARY KEY ("Id")
    );
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309070232_SyncSnapshotCheck') THEN
    CREATE INDEX IF NOT EXISTS "IX_ReplayOperations_CompanyId_State_RequestedAtUtc" ON "ReplayOperations" ("CompanyId", "State", "RequestedAtUtc");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309070232_SyncSnapshotCheck') THEN
    CREATE INDEX IF NOT EXISTS "IX_ReplayOperations_RetriedFromOperationId" ON "ReplayOperations" ("RetriedFromOperationId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309070232_SyncSnapshotCheck') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260309070232_SyncSnapshotCheck', '10.0.3');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    ALTER TABLE "TaskItems" ADD "OrderId" uuid;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    ALTER TABLE "EventStore" ADD "CapturedAtUtc" timestamp with time zone;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    ALTER TABLE "EventStore" ADD "CausationId" uuid;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    ALTER TABLE "EventStore" ADD "IdempotencyKey" character varying(500);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    ALTER TABLE "EventStore" ADD "NextRetryAtUtc" timestamp with time zone;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    ALTER TABLE "EventStore" ADD "PartitionKey" character varying(500);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    ALTER TABLE "EventStore" ADD "PayloadVersion" character varying(20);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    ALTER TABLE "EventStore" ADD "Priority" character varying(50);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    ALTER TABLE "EventStore" ADD "ReplayId" character varying(100);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    ALTER TABLE "EventStore" ADD "RootEventId" uuid;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    ALTER TABLE "EventStore" ADD "SourceModule" character varying(100);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    ALTER TABLE "EventStore" ADD "SourceService" character varying(100);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    ALTER TABLE "EventStore" ADD "SpanId" character varying(64);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    ALTER TABLE "EventStore" ADD "TraceId" character varying(64);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE TABLE IF NOT EXISTS "CommandProcessingLogs" (
        "Id" uuid NOT NULL,
        "IdempotencyKey" character varying(512) NOT NULL,
        "CommandType" character varying(512) NOT NULL,
        "CorrelationId" character varying(128),
        "WorkflowInstanceId" uuid,
        "Status" character varying(32) NOT NULL,
        "ResultJson" character varying(8000),
        "ErrorMessage" character varying(2000),
        "CompletedAtUtc" timestamp with time zone,
        "CreatedAtUtc" timestamp with time zone NOT NULL,
        CONSTRAINT "PK_CommandProcessingLogs" PRIMARY KEY ("Id")
    );
    END IF;
END $EF$;
...
BEGIN
    ...
    CREATE TABLE IF NOT EXISTS "InboundWebhookReceipts" (
        ...
        "ExternalEventId" character varying(256),
        "ConnectorKey" character varying(128) NOT NULL,
        "MessageType" character varying(128),
        "Status" character varying(32) NOT NULL,
        "PayloadJson" jsonb NOT NULL,
        "CorrelationId" character varying(128),
        "VerificationPassed" boolean NOT NULL,
        "VerificationFailureReason" character varying(2000),
        "ReceivedAtUtc" timestamp with time zone NOT NULL,
        "ProcessedAtUtc" timestamp with time zone,
        "HandlerErrorMessage" character varying(2000),
        "HandlerAttemptCount" integer,
        "CreatedAtUtc" timestamp with time zone NOT NULL,
        "UpdatedAtUtc" timestamp with time zone NOT NULL,
...
BEGIN
    ...
    CREATE TABLE IF NOT EXISTS "WorkflowInstances" (
        ...
        "WorkflowType" character varying(128) NOT NULL,
        "EntityType" character varying(128) NOT NULL,
        "EntityId" uuid NOT NULL,
        "CurrentStep" character varying(256) NOT NULL,
        "Status" character varying(32) NOT NULL,
        "CorrelationId" character varying(128),
        "PayloadJson" character varying(8000),
        "CompanyId" uuid,
        "CreatedAt" timestamp with time zone NOT NULL,
        "UpdatedAt" timestamp with time zone NOT NULL,
        "CompletedAt" timestamp with time zone,
...
BEGIN
    ...
    CREATE TABLE IF NOT EXISTS "WorkflowSteps" (
        ...
        "CompletedAt" timestamp with time zone,
        "PayloadJson" character varying(8000),
        "CompensationDataJson" character varying(8000),
        CONSTRAINT "PK_WorkflowSteps" PRIMARY KEY ("Id"),
        CONSTRAINT "FK_WorkflowSteps_WorkflowInstances_WorkflowInstanceId" FOREIGN KEY ("WorkflowInstanceId") REFERENCES "WorkflowInstances" ("Id") ON DELETE CASCADE
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_CommandProcessingLogs_IdempotencyKey" ON "CommandProcessingLogs" ("IdempotencyKey");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE INDEX IF NOT EXISTS "IX_CommandProcessingLogs_Status_CreatedAtUtc" ON "CommandProcessingLogs" ("Status", "CreatedAtUtc");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE INDEX IF NOT EXISTS "IX_OutboundIntegrationDeliveries_ConnectorEndpointId_Status_Cr~" ON "OutboundIntegrationDeliveries" ("ConnectorEndpointId", "Status", "CreatedAtUtc");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE INDEX IF NOT EXISTS "IX_WorkflowInstances_CorrelationId" ON "WorkflowInstances" ("CorrelationId") WHERE "CorrelationId" IS NOT NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE INDEX IF NOT EXISTS "IX_WorkflowInstances_WorkflowType_EntityType_EntityId" ON "WorkflowInstances" ("WorkflowType", "EntityType", "EntityId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE INDEX IF NOT EXISTS "IX_WorkflowSteps_WorkflowInstanceId" ON "WorkflowSteps" ("WorkflowInstanceId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260310031127_AddExternalIntegrationBus', '10.0.3');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310041112_Phase12_SubscriptionBilling') THEN
    CREATE INDEX IF NOT EXISTS "IX_BillingPlans_IsActive" ON "BillingPlans" ("IsActive");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310041112_Phase12_SubscriptionBilling') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_BillingPlans_Slug" ON "BillingPlans" ("Slug");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310041112_Phase12_SubscriptionBilling') THEN
    CREATE INDEX IF NOT EXISTS "IX_TenantInvoices_TenantId" ON "TenantInvoices" ("TenantId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310041112_Phase12_SubscriptionBilling') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_TenantInvoices_TenantId_InvoiceNumber" ON "TenantInvoices" ("TenantId", "InvoiceNumber");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310041112_Phase12_SubscriptionBilling') THEN
    CREATE INDEX IF NOT EXISTS "IX_TenantSubscriptions_BillingPlanId" ON "TenantSubscriptions" ("BillingPlanId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310041112_Phase12_SubscriptionBilling') THEN
    CREATE INDEX IF NOT EXISTS "IX_TenantSubscriptions_ExternalSubscriptionId" ON "TenantSubscriptions" ("ExternalSubscriptionId") WHERE "ExternalSubscriptionId" IS NOT NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310041112_Phase12_SubscriptionBilling') THEN
    CREATE INDEX IF NOT EXISTS "IX_TenantSubscriptions_Status" ON "TenantSubscriptions" ("Status");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310041112_Phase12_SubscriptionBilling') THEN
    CREATE INDEX IF NOT EXISTS "IX_TenantSubscriptions_TenantId" ON "TenantSubscriptions" ("TenantId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310041112_Phase12_SubscriptionBilling') THEN
    CREATE INDEX IF NOT EXISTS "IX_TenantUsageRecords_TenantId_MetricKey_PeriodStartUtc" ON "TenantUsageRecords" ("TenantId", "MetricKey", "PeriodStartUtc");
    END IF;
END $EF$;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310042938_AddMultiTenantArchitecture') THEN
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310042938_AddMultiTenantArchitecture') THEN
    ALTER TABLE "Companies" ADD "Code" character varying(50);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310042938_AddMultiTenantArchitecture') THEN
    ALTER TABLE "Companies" ADD "SubscriptionId" uuid;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310042938_AddMultiTenantArchitecture') THEN
    ALTER TABLE "BackgroundJobs" ADD "CompanyId" uuid;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310042938_AddMultiTenantArchitecture') THEN
    CREATE INDEX IF NOT EXISTS "IX_BackgroundJobs_CompanyId" ON "BackgroundJobs" ("CompanyId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310042938_AddMultiTenantArchitecture') THEN
    CREATE INDEX IF NOT EXISTS "IX_BackgroundJobs_CompanyId_State_CreatedAt" ON "BackgroundJobs" ("CompanyId", "State", "CreatedAt");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310042938_AddMultiTenantArchitecture') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260310042938_AddMultiTenantArchitecture', '10.0.3');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310065356_AddOperationalInsightsAndFeatureFlags') THEN
    CREATE TABLE IF NOT EXISTS "BillingPlanFeatures" (
        "Id" uuid NOT NULL,
        "BillingPlanId" uuid NOT NULL,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310065356_AddOperationalInsightsAndFeatureFlags') THEN
    CREATE TABLE IF NOT EXISTS "OperationalInsights" (
        "Id" uuid NOT NULL,
        "CompanyId" uuid NOT NULL,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310065356_AddOperationalInsightsAndFeatureFlags') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_BillingPlanFeatures_BillingPlanId_FeatureKey" ON "BillingPlanFeatures" ("BillingPlanId", "FeatureKey");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310065356_AddOperationalInsightsAndFeatureFlags') THEN
    CREATE INDEX IF NOT EXISTS "IX_OperationalInsights_CompanyId_OccurredAtUtc" ON "OperationalInsights" ("CompanyId", "OccurredAtUtc");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310065356_AddOperationalInsightsAndFeatureFlags') THEN
    CREATE INDEX IF NOT EXISTS "IX_OperationalInsights_CompanyId_Type" ON "OperationalInsights" ("CompanyId", "Type");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310065356_AddOperationalInsightsAndFeatureFlags') THEN
    CREATE UNIQUE INDEX IF NOT EXISTS "IX_TenantFeatureFlags_TenantId_FeatureKey" ON "TenantFeatureFlags" ("TenantId", "FeatureKey");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310065356_AddOperationalInsightsAndFeatureFlags') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260310065356_AddOperationalInsightsAndFeatureFlags', '10.0.3');
    END IF;
END $EF$;
COMMIT;
