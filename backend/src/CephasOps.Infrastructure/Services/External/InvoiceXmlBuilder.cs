...
/// Moved to Infrastructure since it's only used by MyInvoisApiProvider
/// </summary>
public class InvoiceXmlBuilder
{
        ...
        var xml = new XDocument(
            ...
            new XElement("CreditNote",
                ...
                new XElement("CreditNoteLines",
                    creditNote.LineItems.Select(item =>
    ...
    {
        if (string.IsNullOrEmpty(party.AddressLine1) && 
        ...
        return new XElement(elementName,
            !string.IsNullOrEmpty(party.AddressLine1)
                ? new XElement("Street", party.AddressLine1)
                : null,
            !string.IsNullOrEmpty(party.AddressLine2)
                ? new XElement("City", party.AddressLine2)
                : null,
            !string.IsNullOrEmpty(party.City)
            ...
            !string.IsNullOrEmpty(party.Postcode)
                ...
                : null,
            new XElement("Country", party.CountryCode)
        );
    }
