...
BEGIN
    ...
    CREATE TABLE "RebuildOperations" (
        "Id" uuid NOT NULL,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309044417_AddRebuildOperations') THEN
    CREATE INDEX "IX_RebuildOperations_RebuildTargetId" ON "RebuildOperations" ("RebuildTargetId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309044417_AddRebuildOperations') THEN
    CREATE INDEX "IX_RebuildOperations_RequestedAtUtc" ON "RebuildOperations" ("RequestedAtUtc");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309044417_AddRebuildOperations') THEN
    CREATE INDEX "IX_RebuildOperations_ScopeCompanyId_RequestedAtUtc" ON "RebuildOperations" ("ScopeCompanyId", "RequestedAtUtc");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309050021_RebuildPhase2CheckpointAndLock') THEN
    CREATE TABLE "RebuildExecutionLocks" (
        "Id" uuid NOT NULL,
        "RebuildTargetId" character varying(128) NOT NULL,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309050021_RebuildPhase2CheckpointAndLock') THEN
    CREATE INDEX "IX_RebuildOperations_BackgroundJobId" ON "RebuildOperations" ("BackgroundJobId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309050021_RebuildPhase2CheckpointAndLock') THEN
    CREATE INDEX "IX_RebuildOperations_State_RequestedAtUtc" ON "RebuildOperations" ("State", "RequestedAtUtc");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309050021_RebuildPhase2CheckpointAndLock') THEN
    CREATE INDEX "IX_RebuildExecutionLocks_RebuildOperationId" ON "RebuildExecutionLocks" ("RebuildOperationId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309050021_RebuildPhase2CheckpointAndLock') THEN
    CREATE UNIQUE INDEX "IX_RebuildExecutionLocks_RebuildTargetId_ScopeKey" ON "RebuildExecutionLocks" ("RebuildTargetId", "ScopeKey") WHERE "ReleasedAtUtc" IS NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309050021_RebuildPhase2CheckpointAndLock') THEN
    CREATE INDEX "IX_RebuildExecutionLocks_ReleasedAtUtc" ON "RebuildExecutionLocks" ("ReleasedAtUtc");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309051147_AddWorkerInstancesAndJobOwnership') THEN
    CREATE INDEX "IX_ReplayOperations_WorkerId" ON "ReplayOperations" ("WorkerId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309051147_AddWorkerInstancesAndJobOwnership') THEN
    CREATE INDEX "IX_RebuildOperations_WorkerId" ON "RebuildOperations" ("WorkerId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309051147_AddWorkerInstancesAndJobOwnership') THEN
    CREATE INDEX "IX_WorkerInstances_IsActive_LastHeartbeatUtc" ON "WorkerInstances" ("IsActive", "LastHeartbeatUtc");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309051147_AddWorkerInstancesAndJobOwnership') THEN
    CREATE INDEX "IX_WorkerInstances_LastHeartbeatUtc" ON "WorkerInstances" ("LastHeartbeatUtc");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309053019_AddBackgroundJobWorkerOwnership') THEN
    CREATE INDEX "IX_BackgroundJobs_State_WorkerId" ON "BackgroundJobs" ("State", "WorkerId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309053019_AddBackgroundJobWorkerOwnership') THEN
    CREATE INDEX "IX_BackgroundJobs_WorkerId" ON "BackgroundJobs" ("WorkerId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309060310_AddOrderIdToTaskItem') THEN
    CREATE INDEX "IX_TaskItems_CompanyId_OrderId" ON "TaskItems" ("CompanyId", "OrderId") WHERE "OrderId" IS NOT NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309065950_VerifyNoPending') THEN
    CREATE TABLE "EventStoreAttemptHistory" (
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309065950_VerifyNoPending') THEN
    CREATE INDEX "IX_EventStoreAttemptHistory_EventId" ON "EventStoreAttemptHistory" ("EventId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309065950_VerifyNoPending') THEN
    CREATE INDEX "IX_EventStoreAttemptHistory_EventId_AttemptNumber" ON "EventStoreAttemptHistory" ("EventId", "AttemptNumber");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309070232_SyncSnapshotCheck') THEN
    CREATE TABLE "ParsedMaterialAliases" (
        "Id" uuid NOT NULL,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309070232_SyncSnapshotCheck') THEN
    CREATE TABLE "ReplayOperationEvents" (
        "Id" uuid NOT NULL,
        "ReplayOperationId" uuid NOT NULL,
        "EventId" uuid NOT NULL,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309070232_SyncSnapshotCheck') THEN
    CREATE INDEX "IX_ReplayOperationEvents_EventId" ON "ReplayOperationEvents" ("EventId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309070232_SyncSnapshotCheck') THEN
    CREATE INDEX "IX_ReplayOperationEvents_ReplayOperationId" ON "ReplayOperationEvents" ("ReplayOperationId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309070232_SyncSnapshotCheck') THEN
    CREATE INDEX "IX_ReplayOperations_CompanyId_RequestedAtUtc" ON "ReplayOperations" ("CompanyId", "RequestedAtUtc");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309070232_SyncSnapshotCheck') THEN
    CREATE INDEX "IX_ReplayOperations_CompanyId_State_RequestedAtUtc" ON "ReplayOperations" ("CompanyId", "State", "RequestedAtUtc");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309070232_SyncSnapshotCheck') THEN
    CREATE INDEX "IX_ReplayOperations_RequestedAtUtc" ON "ReplayOperations" ("RequestedAtUtc");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309070232_SyncSnapshotCheck') THEN
    CREATE INDEX "IX_ReplayOperations_RequestedByUserId" ON "ReplayOperations" ("RequestedByUserId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260309070232_SyncSnapshotCheck') THEN
    CREATE INDEX "IX_ReplayOperations_RetriedFromOperationId" ON "ReplayOperations" ("RetriedFromOperationId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE TABLE "CommandProcessingLogs" (
        "Id" uuid NOT NULL,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE TABLE "ConnectorDefinitions" (
        "Id" uuid NOT NULL,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE TABLE "ExternalIdempotencyRecords" (
        "Id" uuid NOT NULL,
        "IdempotencyKey" character varying(512) NOT NULL,
        "ConnectorKey" character varying(128) NOT NULL,
        "CompanyId" uuid,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE TABLE "OutboundIntegrationDeliveries" (
        "Id" uuid NOT NULL,
        "ConnectorEndpointId" uuid NOT NULL,
        "CompanyId" uuid,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE TABLE "ConnectorEndpoints" (
        "Id" uuid NOT NULL,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE TABLE "OutboundIntegrationAttempts" (
        "Id" uuid NOT NULL,
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE INDEX "IX_EventStore_PartitionKey" ON "EventStore" ("PartitionKey") WHERE "PartitionKey" IS NOT NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE INDEX "IX_EventStore_PartitionKey_CreatedAtUtc_EventId" ON "EventStore" ("PartitionKey", "CreatedAtUtc", "EventId") WHERE "PartitionKey" IS NOT NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE INDEX "IX_EventStore_ReplayId" ON "EventStore" ("ReplayId") WHERE "ReplayId" IS NOT NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE INDEX "IX_EventStore_RootEventId" ON "EventStore" ("RootEventId") WHERE "RootEventId" IS NOT NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE INDEX "IX_EventStore_Status_NextRetryAtUtc" ON "EventStore" ("Status", "NextRetryAtUtc");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE UNIQUE INDEX "IX_CommandProcessingLogs_IdempotencyKey" ON "CommandProcessingLogs" ("IdempotencyKey");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE INDEX "IX_CommandProcessingLogs_Status_CreatedAtUtc" ON "CommandProcessingLogs" ("Status", "CreatedAtUtc");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE UNIQUE INDEX "IX_ConnectorDefinitions_ConnectorKey" ON "ConnectorDefinitions" ("ConnectorKey");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE INDEX "IX_ConnectorEndpoints_CompanyId" ON "ConnectorEndpoints" ("CompanyId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE INDEX "IX_ConnectorEndpoints_ConnectorDefinitionId_CompanyId" ON "ConnectorEndpoints" ("ConnectorDefinitionId", "CompanyId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE INDEX "IX_ExternalIdempotencyRecords_ConnectorKey_CompletedAtUtc" ON "ExternalIdempotencyRecords" ("ConnectorKey", "CompletedAtUtc");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE UNIQUE INDEX "IX_ExternalIdempotencyRecords_IdempotencyKey" ON "ExternalIdempotencyRecords" ("IdempotencyKey");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE INDEX "IX_InboundWebhookReceipts_CompanyId" ON "InboundWebhookReceipts" ("CompanyId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE UNIQUE INDEX "IX_InboundWebhookReceipts_ConnectorKey_ExternalIdempotencyKey" ON "InboundWebhookReceipts" ("ConnectorKey", "ExternalIdempotencyKey");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE INDEX "IX_InboundWebhookReceipts_ConnectorKey_Status_ReceivedAtUtc" ON "InboundWebhookReceipts" ("ConnectorKey", "Status", "ReceivedAtUtc");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE INDEX "IX_JobExecutions_CompanyId_Status" ON "JobExecutions" ("CompanyId", "Status");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE INDEX "IX_JobExecutions_Status_NextRunAtUtc" ON "JobExecutions" ("Status", "NextRunAtUtc");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE INDEX "IX_NotificationDispatches_CompanyId_Status" ON "NotificationDispatches" ("CompanyId", "Status");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE UNIQUE INDEX "IX_NotificationDispatches_IdempotencyKey" ON "NotificationDispatches" ("IdempotencyKey") WHERE "IdempotencyKey" IS NOT NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE INDEX "IX_NotificationDispatches_Status_NextRetryAtUtc" ON "NotificationDispatches" ("Status", "NextRetryAtUtc");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE INDEX "IX_OutboundIntegrationAttempts_OutboundDeliveryId" ON "OutboundIntegrationAttempts" ("OutboundDeliveryId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE INDEX "IX_OutboundIntegrationDeliveries_CompanyId_Status_CreatedAtUtc" ON "OutboundIntegrationDeliveries" ("CompanyId", "Status", "CreatedAtUtc");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE INDEX "IX_OutboundIntegrationDeliveries_ConnectorEndpointId_Status_Cr~" ON "OutboundIntegrationDeliveries" ("ConnectorEndpointId", "Status", "CreatedAtUtc");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE INDEX "IX_OutboundIntegrationDeliveries_EventType_Status" ON "OutboundIntegrationDeliveries" ("EventType", "Status");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE UNIQUE INDEX "IX_OutboundIntegrationDeliveries_IdempotencyKey" ON "OutboundIntegrationDeliveries" ("IdempotencyKey");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE INDEX "IX_OutboundIntegrationDeliveries_NextRetryAtUtc" ON "OutboundIntegrationDeliveries" ("NextRetryAtUtc") WHERE "NextRetryAtUtc" IS NOT NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE INDEX "IX_WorkflowInstances_CorrelationId" ON "WorkflowInstances" ("CorrelationId") WHERE "CorrelationId" IS NOT NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310031127_AddExternalIntegrationBus') THEN
    CREATE INDEX "IX_WorkflowInstances_WorkflowType_EntityType_EntityId" ON "WorkflowInstances" ("WorkflowType", "EntityType", "EntityId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310042938_AddMultiTenantArchitecture') THEN
    CREATE INDEX "IX_BackgroundJobs_CompanyId" ON "BackgroundJobs" ("CompanyId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260310042938_AddMultiTenantArchitecture') THEN
    CREATE INDEX "IX_BackgroundJobs_CompanyId_State_CreatedAt" ON "BackgroundJobs" ("CompanyId", "State", "CreatedAt");
    END IF;
END $EF$;
